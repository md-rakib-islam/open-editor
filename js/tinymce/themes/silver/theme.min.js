...
!(function () {
  ...
  var Zv = tinymce.util.Tools.resolve("tinymce.util.I18n");
  const ex = {
      indent: !0,
      outdent: !0,
  ...
  var wS = tinymce.util.Tools.resolve("tinymce.util.LocalStorage");
  const SS = {},
    CS = (e) =>
      fe(SS, e).getOrThunk(() => {
        const t = `tinymce-custom-colors-${e}`,
          o = wS.getItem(t);
        if (m(o)) {
          const e = wS.getItem("tinymce-custom-colors");
          wS.setItem(t, g(e) ? e : "[]");
        }
        const n = ((e, t = 10) => {
  ...
  var nk = tinymce.util.Tools.resolve("tinymce.html.Entities");
  const sk = (e, t, o, n) => {
      const s = rk(e, t, o, n);
      return ok.sketch(s);
    },
  ...
  var V_ = tinymce.util.Tools.resolve("tinymce.Resource");
  const L_ = (e) => be(e, "init");
  var H_ = tinymce.util.Tools.resolve("tinymce.util.Tools");
  ...
  const TM = y(Di("toolbar-height-change")),
    ...
    AM = "tox-tinymce--toolbar-sticky-on",
  ...
  const gB = {
    ...
    vB = (e) => A.from(tinymce.Resource.get(e)).filter(r),
    xB = (e, t, o = "") => {
      const n = ((e) => {
          const t = pb(e);
            ...
            y = pl(
              mB.sketch({
                ...
                behaviours: ca([
                  ...
                  ug.config({ disableClass: "tox-tinymce--disabled" }),
                  bh.config({
                    mode: "cyclic",
                    selector:
  ...
  var OV = tinymce.util.Tools.resolve("tinymce.util.URI");
  const _V = [
      "insertContent",
      "setContent",
      "execCommand",
