...
!(function () {
          ...
          ((e) => {
            if (d(e.target)) {
              ...
              if (P(t) && d(t.dom.shadowRoot) && e.composed && e.composedPath) {
                ...
                if (t)
                  return ((e) => (0 < e.length ? y.some(e[0]) : y.none()))(t);
              }
            }
  ...
  const Pe = (e, t) => ({
    ...
    We = (e, t, n) =>
      Ne(n)
        ...
        .getOrThunk(() => ({ unbind: g }));
  var qe = trendymc.util.Tools.resolve("trendymc.dom.DOMUtils"),
    Be = trendymc.util.Tools.resolve("trendymc.Env");
  const Ie = (e, t) => {
      e.dispatch("FullscreenStateChanged", { state: t }),
        e.dispatch("ResizeEditor");
    },
    je = (e) => e.options.get("fullscreen_native");
  const _e = (e) => {
      return (
        e.dom ===
    ...
    Ke = (e, t) =>
      ((e) => {
        return E(
          ((e) => y.from(e.dom.parentNode).map(I))((n = e))
            .map(z)
            .map((e) =>
              E(e, (e) => {
  ...
  var et = trendymc.util.Tools.resolve("trendymc.util.VK");
  const tt = (e, t) => (n) => {
