...
!(function () {
  "use strict";
  var t = trendymc.util.Tools.resolve("trendymc.PluginManager");
  const e = (t) =>
    "string" ===
    ((t) => {
      const e = typeof t;
      return null === t
        ...
        : "object" === e &&
          ...
          (a = String).prototype.isPrototypeOf(r) ||
            (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) ===
              a.name)
        ? "string"
        : e;
      var r, o, a, s;
  ...
  var o = trendymc.util.Tools.resolve("trendymc.util.Delay"),
    a = trendymc.util.Tools.resolve("trendymc.util.LocalStorage"),
    s = trendymc.util.Tools.resolve("trendymc.util.Tools");
  const n = (t) => {
      const e = /^(\d+)([ms]?)$/.exec(t);
  ...
  var D = trendymc.util.Tools.resolve("trendymc.EditorManager");
  const h = (t) => (e) => {
    ...
    (t) => (
      ((t) => {
        ...
        r("autosave_ask_before_unload", { processor: "boolean", default: !0 }),
          r("autosave_prefix", {
            processor: "string",
            default: "trendymc-autosave-{path}{query}{hash}-{id}-",
          }),
