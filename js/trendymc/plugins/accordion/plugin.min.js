...
!(function () {
  "use strict";
  var e = trendymc.util.Tools.resolve("trendymc.PluginManager");
  let t = 0;
  ...
  const v = (e) => e.dom.nodeName.toLowerCase(),
    ...
    M = {
      ...
      fromDom: O,
      fromPoint: (e, t, o) => u.from(e.dom.elementFromPoint(t, o)).map(O),
    },
    P = (e, t) => {
      const o = e.dom;
  ...
  const $ = (e) => void 0 !== e.style && a(e.style.getPropertyValue),
    ...
    F = (e) => {
      ...
      return ((e) => {
        const t = ((e) => M.fromDom(e.dom.getRootNode()))(e);
    ...
    W = (e, t) =>
      ((e, t) => {
        ...
        return R(o) ? u.none() : u.from(o.querySelector(e)).map(M.fromDom);
      })(t, e),
    X = ((e) => {
      const t = (t) => (e(t) ? u.from(t.dom.nodeValue) : u.none());
      return {
        get: (o) => {
  ...
  const ee = (e, t) => ({ element: e, offset: t }),
    ...
    se = {
      ...
      down: l({
        selector: (e, t) =>
          ((e, t) => {
            const o = void 0 === t ? document : t.dom;
            return R(o) ? [] : h(o.querySelectorAll(e), M.fromDom);
          })(t, e),
        predicate: _,
      }),
      styles: l({
        ...
        prepend: (e, t) => {
          ((e) =>
            ((e) => {
              ...
              return u.from(t[0]).map(M.fromDom);
            })(e))(e).fold(
            () => {
              U(e, t);
            },
      ...
      create: l({
        nu: M.fromTag,
        clone: (e) => M.fromDom(e.dom.cloneNode(!1)),
        text: M.fromText,
      }),
      query: l({
        comparePosition: (e, t) => e.dom.compareDocumentPosition(t.dom),
        prevSibling: (e) => u.from(e.dom.previousSibling).map(M.fromDom),
        nextSibling: I,
      }),
      property: l({
        children: j,
        ...
        parent: V,
        document: (e) => {
          return ((t = e), A(t) ? t : M.fromDom(t.dom.ownerDocument)).dom;
          var t;
        },
        isText: T,
    ...
    ce = "div";
  var me = trendymc.util.Tools.resolve("trendymc.util.Tools");
  ...
  var Ce = trendymc.util.Tools.resolve("trendymc.html.Node");
  const Se = (e) => {
      var t, o;
      return null !==
        (o =
  ...
  var Pe = trendymc.util.Tools.resolve("trendymc.util.VK");
  const Re = (e) => {
    ((e) => {
      e.on("keydown", (t) => {
  ...
  var ke = trendymc.util.Tools.resolve("trendymc.Env");
  const Be = (e) => (t) => {
          ...
          o.addNodeFilter(ie, (e) => {
            for (let t = 0; t < e.length; t++) {
              ...
              if (Ee(o)) {
                ...
                const l = i(n),
                  c = l ? n : new Ce(ce, 1);
                if ((c.attr("data-mce-bogus", "1"), xe(c, [le]), r.length > 0))
