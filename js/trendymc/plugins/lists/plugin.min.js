...
!(function () {
  ...
  var fe = trendymc.util.Tools.resolve("trendymc.dom.RangeUtils"),
    ye = trendymc.util.Tools.resolve("trendymc.dom.TreeWalker"),
    ve = trendymc.util.Tools.resolve("trendymc.util.VK");
  const Ce = (e) => N(e, $),
    be = Object.keys,
    Ne = (e, t) => {
      const n = be(e);
  ...
  var Te = trendymc.util.Tools.resolve("trendymc.dom.DOMUtils"),
    Ee = trendymc.util.Tools.resolve("trendymc.util.Tools");
  const xe = (e) => (t) => l(t) && t.nodeName.toLowerCase() === e,
    ...
    pt = (e, t) => {
      ...
      return ut(e, n) || !e.selection.isEditable();
    },
    gt = (e, t) => {
  ...
  const Ct = (e, t, n) => {
          ...
          Lt(o)
            ...
            ? ((e, t, n) => {
                const o = ((e, t, n) => {
                  const o = [];
                  for (let r = 0; r < n; r++)
                    o.push(xt(e, St(t) ? t.listType : t.parentListType));
                  return o;
      ...
      S(e, (t, n) => {
        ((e, t) => {
          const n = e[t].depth,
            ...
            r = (e) => e.depth < n;
          return A(x(e.slice(0, t)), o, r).orThunk(() =>
            A(e.slice(t + 1), o, r)
          );
        })(e, n).fold(
          () => {
    ...
    It = (e, t, n) => {
      const o = ((e, t) => {
        ...
        ((e) => {
          const t = N(st(e), $);
          return P(T(t, p(Nt)), T(x(t), p(Nt)), (e, t) => ({
            start: e,
            end: t,
          }));
        })(e)
    ...
    Ut = (e, t) =>
      !((e) => {
        const t = rt(e);
        return ut(e, t) || !e.selection.isEditable();
      })(e) && Rt(e, t),
    $t = (e) => Ut(e, "Indent"),
    _t = (e) => Ut(e, "Outdent"),
    Ht = (e) => Ut(e, "Flatten"),
    Ft = (e) => "\ufeff" === e;
  var Vt = trendymc.util.Tools.resolve("trendymc.dom.BookmarkManager");
  const jt = Te.DOM,
    Kt = (e) => {
      const t = {},
        n = (n) => {
  ...
  var bn = trendymc.util.Tools.resolve("trendymc.html.Node");
  const Nn = (e) => 3 === e.type,
    Sn = (e) => 0 === e.length,
    Ln = (e) => {
      const t = (t, n) => {
