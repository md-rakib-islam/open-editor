...
!(function () {
  ...
  const h = u;
  var g = trendymc.util.Tools.resolve("trendymc.Env"),
    f = trendymc.util.Tools.resolve("trendymc.util.Tools");
  ...
  const O = (e) => 3 === ((e) => e.dom.nodeType)(e);
  const N = (e) => {
    ...
    B = (e) => S.get(e);
  var F = trendymc.util.Tools.resolve("trendymc.dom.TreeWalker");
