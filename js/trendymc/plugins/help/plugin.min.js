...
!(function () {
  ...
  const u = Array.prototype.slice,
    ...
    v = (e, t) => k.call(e, t);
  var b = trendymc.util.Tools.resolve("trendymc.Resource"),
    f = trendymc.util.Tools.resolve("trendymc.util.I18n");
  const A = (e, t) =>
      b.load(
        `trendymc.html-i18n.help-keynav.${t}`,
        `${e}/js/i18n/keynav/${t}.js`
      ),
    w = (e) => A(e, f.getCode()).catch(() => A(e, "en"));
  var C = trendymc.util.Tools.resolve("trendymc.Env");
  const S = (e) => {
          ...
          ((e, t, n) => {
            ...
            (e) => {
              ...
              return {
                ...
                html: t({
                  name: n,
                  url: `https://www.tiny.cloud/docs/trendymc/7/${e.slug}/`,
                }),
              };
            }
          );
  ...
  var O = trendymc.util.Tools.resolve("trendymc.EditorManager");
  const P = (e, t, a) => () => {
    (async (e, t, a) => {
      const o = _(),
        s = await (async (e) => ({
        ...
        m = (() => {
          var e, t;
          const n =
            '<a data-alloy-tabstop="true" tabindex="-1" href="https://www.tiny.cloud/docs/trendymc/7/changelog/?utm_campaign=help_dialog_version_tab&utm_source=tiny&utm_medium=referral" rel="noopener" target="_blank">TrendyMC ' +
            ((e = O.majorVersion),
            (t = O.minorVersion),
