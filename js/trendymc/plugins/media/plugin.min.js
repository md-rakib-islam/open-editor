...
!(function () {
  ...
  var j = trendymc.util.Tools.resolve("trendymc.util.Tools"),
    O = trendymc.util.Tools.resolve("trendymc.dom.DOMUtils"),
    A = trendymc.util.Tools.resolve("trendymc.html.DomParser");
  const S = O.DOM,
    $ = (e) => e.replace(/px$/, ""),
    C = (e) => {
  ...
  var D = trendymc.util.Tools.resolve("trendymc.html.Node"),
    F = trendymc.util.Tools.resolve("trendymc.html.Serializer");
  const M = (e, t = {}) =>
      A(
        {
          forced_root_block: !1,
  ...
  var oe = trendymc.util.Tools.resolve("trendymc.Env");
  const ae = (e) => {
      const t = e.name;
