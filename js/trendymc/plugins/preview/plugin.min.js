...
!(function () {
  ...
  const o = () => a(0, 0),
    ...
    m = [
      ...
      },
      {
        name: "Chromium",
        brand: "Chromium",
        versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, l],
      ...
      {
        name: "Opera",
        versionRegexes: [l, /.*?opera\/([0-9]+)\.([0-9]+).*/],
        search: h("opera"),
      },
      {
        name: "Firefox",
      ...
      {
        name: "Safari",
        versionRegexes: [l, /.*?cpu os ([0-9]+)_([0-9]+).*/],
        search: (e) =>
          (d(e, "safari") || d(e, "mobile/")) && d(e, "applewebkit"),
      },
    ],
    v = [
      {
    ...
    b = () => y({ current: void 0, version: c.unknown() }),
    O = y,
    R = (n(p), n(w), n("IE"), n(f), n(x), n(S), "Windows"),
    C = "Android",
    A = "Linux",
    k = "macOS",
    D = "Solaris",
    ...
    T = () => P({ current: void 0, version: c.unknown() }),
    _ = P,
    B =
      (n(R),
      n("iOS"),
      ...
      (e, t, s) => {
        const o = g.browsers(),
              ...
              ((e, t) =>
                ((e, t) => {
                  ...
                  return i(e, (e) => {
                    ...
                    current: e.name,
                    version: c.nu(parseInt(t.version, 10), 0),
                  }));
                }))(o, e)
            )
            .orThunk(() =>
              ((e, t) =>
                u(e, t).map((e) => {
                  const r = c.detect(e.versionRegexes, t);
          ...
          h = ((e, t, r, s) => {
            const i = e.isiOS() && !0 === /ipad/i.test(r),
              o = e.isiOS() && !i,
        ...
        return { browser: d, os: l, deviceType: h };
      }),
  ...
  let N = ((e) => {
    ...
    B(window.navigator.userAgent, r.from(window.navigator.userAgentData), L)
  );
  const F = () => N();
  var M = trendymc.util.Tools.resolve("trendymc.util.Tools");
