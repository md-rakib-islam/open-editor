...
!(function () {
  ...
  const h = Array.prototype.indexOf,
    ...
    B = (e, t) => D.call(e, t);
  var I = trendymc.util.Tools.resolve("trendymc.util.URI"),
    K = trendymc.util.Tools.resolve("trendymc.dom.TreeWalker"),
    j = trendymc.util.Tools.resolve("trendymc.util.Tools");
  const U = (e) => a(e) && "a" === e.nodeName.toLowerCase(),
    ...
    Z = (e) =>
      a(e) && "FIGURE" === e.nodeName && /\bimage\b/i.test(e.className),
    ee = (e, t, n) => {
  ...
  var pe = trendymc.util.Tools.resolve("trendymc.util.Delay");
  const fe = (e) => {
      const t = e.href;
      return t.indexOf("@") > 0 &&
        -1 === t.indexOf("/") &&
  ...
  var Ae = trendymc.util.Tools.resolve("trendymc.util.VK");
  const Ne = (e, t) => {
      if (t) {
        const o = $(t);
        if (/^#/.test(o)) {
