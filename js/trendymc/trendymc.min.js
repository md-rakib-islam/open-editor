...
!(function () {
  ...
  const Xn = (e, t, n) => {
    ...
    No = (e, t, n, o) =>
      ((e, t, n, o, r) => {
        ...
        return e.dom.addEventListener(t, s, r), { unbind: T(Ro, e, t, s, r) };
      })(e, t, n, o, !1),
    Ro = (e, t, n, o) => {
  ...
  const Vo = "\ufeff",
    ...
    xr = tr("details"),
    _r = tr("summary"),
    kr = { skipBogus: !0, includeZwsp: !1, checkRootAsContent: !1 },
    Sr = (e) => Jo(e) && e.hasAttribute("data-mce-bookmark");
  const Nr = (e, t, n, o) =>
      lr(e) &&
      !((e, t, n) =>
        Yo(e.data) &&
    ...
    Or = (e, t, n) => Rr(e, t, t, { includeZwsp: kr.includeZwsp, ...n }),
    Br = (e) => {
      let t = e;
      return {
        get: () => t,
    ...
    Gr = (e, t) => _e(e.getTransparentElements(), t),
    ...
    Ss = (e) => {
      const { blockContent: t, phrasingContent: n, flowContent: o } = ks(e),
    ...
    Fs = (e = {}) => {
      ...
      const s = {},
        ...
        d = ((e) => {
          const t = _s(e),
            { phrasingContent: n, flowContent: o } = ks(e),
            r = {},
            s = (e, t, n) => {
              r[e] = {
                attributes: se(t, N({})),
    ...
    Gs = (e, t) => {
      const n = null != t ? t : {};
      for (const t in e) _e(Ys, t) || (n[t] = e[t]);
      return (
    ...
    ma = (e, t = {}) => {
      ...
      const a = rs.forElement(Cn(e), {
        ...
        Y = {
          ...
          events: c,
          isBlock: (e) =>
            m(e) ? _e(u, e) : Jo(e) && (_e(u, e.nodeName) || Zr(l, e)),
          root: null,
          ...
          const o = t.keep_values,
            ...
            s = {
              style: {
                set: (t, n) => {
                  const r = Cn(t);
                  o && ia(r, sa, n), rn(r, "style"), m(n) && lo(r, e.parse(n));
                },
                get: (t) => {
                  const n = Cn(t),
  ...
  const Ca = (e, t) => {
    ...
    ka = N("data-mce-annotation-active"),
    ...
    Ta = (e, t) =>
      on(e, "data-mce-bogus") ||
      ((e, t, n) => Jn(e, '[data-mce-bogus="all"]', n).isSome())(e, 0, Ra(t)),
    Oa = (e, t) => {
  ...
  const La = (e) => {
    ...
    ri = lr,
    si = (e) => (
      ri(e) && (e = e.parentNode), oi(e) && e.hasAttribute("data-mce-caret")
    ),
    ai = (e) => ri(e) && ti(e.data),
    ii = (e) => si(e) || ai(e),
    ...
    di = (e) => {
      ...
      return (
        !!lr(t) &&
        (t.data.charAt(e.offset()) === ei ||
          (e.isAtStart() && ai(t.previousSibling)))
      );
    },
    ci = (e) => {
      const t = e.container();
      return (
        !!lr(t) &&
        (t.data.charAt(e.offset() - 1) === ei ||
          (e.isAtEnd() && ai(t.nextSibling)))
      );
    },
    ...
    yi = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && vi(t.top - e.bottom, e, t))
      );
    },
    Ci = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && vi(t.bottom - e.top, e, t)),
    wi = (e, t, n) => {
    ...
    ki = (e) => m(e) && e.charCodeAt(0) >= 768 && _i.test(e),
    Si = hr,
    Ni = br,
    Ri = gr,
    Ai = lr,
    ...
    Pi = ii,
    Di = (e) =>
      !Pi(e) && (Ai(e) ? !Ti(e.parentNode) : Oi(e) || Ri(e) || Bi(e) || Li(e)),
    Li = (e) =>
      !((e) => Jo(e) && "true" === e.getAttribute("unselectable"))(e) && Ni(e),
    Mi = (e, t) =>
      Di(e) &&
      ((e, t) => {
    ...
    Qi = (e) => {
      ...
      return (
        (n = o.length > 0 ? hi(o[0]) : hi(e.getBoundingClientRect())),
        !Gi(e) && Vi(e) && Zi(n)
          ? ((e) => {
          ...
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                if (t < e.data.length) {
                  ...
                  if (
                    ki(e.data[t - 1]) &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), !Xi(o))
                  )
            ...
            if (Ii(r))
              if (e.isAtEnd()) {
                ...
                const a = Wi(r, s);
                if (($i(a) && o(a, 0), ji(a) && e.isAtEnd()))
                  return n(Ji(Qi(a), !1)), t;
  ...
  (el.fromRangeStart = (e) => el(e.startContainer, e.startOffset)),
    ...
    (el.isAbove = (e, t) =>
      It(le(t.getClientRects()), de(e.getClientRects()), yi).getOr(!1)),
    (el.isBelow = (e, t) =>
      It(de(t.getClientRects()), le(e.getClientRects()), Ci).getOr(!1)),
  ...
  const tl = (e, t) => {
    ...
    nl = (e, t, n) => {
      fr(n)
        ...
        : ((e, t, n) => {
            t.insertNode(n), tl(e, n.previousSibling), tl(e, n.nextSibling);
          })(e, t, n);
    },
    ol = lr,
    rl = rr,
    ...
    il = (e) =>
      e
        ? Be(
            e.childNodes,
            (e, t) => (
              rl(t) && "BR" !== t.nodeName ? (e = e.concat(il(t))) : e.push(t),
              e
            ),
            []
          )
    ...
    ll = (e) => (t) => e === t,
    dl = (e) =>
      (ol(e) ? "text()" : e.nodeName.toLowerCase()) +
      "[" +
      ((e) => {
        let t, n;
        (t = il(al(e))), (n = Pe(t, ll(e), e)), (t = t.slice(0, n + 1));
        const o = Be(t, (e, n, o) => (ol(n) && ol(t[o - 1]) && e++, e), 0);
        return (t = Oe(t, nr([e.nodeName]))), (n = Pe(t, ll(e), e)), n - o;
      })(e) +
      "]",
    cl = (e, t) => {
      let n,
      ...
      if (ol(r))
        n = ((e, t) => {
          let n = e;
          for (; (n = n.previousSibling) && ol(n); ) t += n.data.length;
          return t;
        })(r, s);
      else {
    ...
    ul = (e, t) => {
      ...
      if (!ol(s) && s.parentNode) {
        let e;
        return (e = "after" === r ? sl(s) + 1 : sl(s)), el(s.parentNode, e);
      }
      return ((e, t) => {
        let n = e,
          o = 0;
        ...
        return ol(e) && t > e.data.length && (t = e.data.length), el(e, t);
      })(s, parseInt(r, 10));
    },
    ml = br,
    fl = (e, t, n, o, r) => {
    ...
    hl = (e) => (pl(e, !0), pl(e, !1), e),
    bl = (e, t) => {
      if (Jo(e) && ((e = xi(e, t)), ml(e))) return e;
      if (ii(e)) {
        lr(e) && si(e) && (e = e.parentNode);
        let t = e.previousSibling;
        if (ml(t)) return t;
        if (((t = e.nextSibling), ml(t))) return t;
      }
    },
    vl = (e, t, n) => {
      const o = n.getNode(),
      ...
      if ("IMG" === o.nodeName || ml(o)) {
        const e = o.nodeName;
        return { name: e, index: gl(n.dom, e, o) };
      }
      const s = ((e) =>
        bl(e.startContainer, e.startOffset) || bl(e.endContainer, e.endOffset))(
        r
      );
      if (s) {
        const e = s.tagName;
        return { name: e, index: gl(n.dom, e, s) };
      }
      return ((e, t, n, o) => {
        const r = t.dom,
          s = fl(r, e, n, o, !0),
          a = t.isForward(),
          i = gi(o) ? { isFakeCaret: !0 } : {};
        return t.isCollapsed()
          ? { start: s, forward: a, ...i }
          : { start: s, end: fl(r, e, n, o, !1), forward: a, ...i };
      })(e, n, t, r);
    },
    yl = (e, t, n) => {
      const o = {
    ...
    Cl = (e, t) => {
      ...
      const r = n.uniqueId(),
        ...
        i = a.nodeName,
        l = e.isForward();
      if ("IMG" === i) return { name: i, index: gl(n, i, a) };
  ...
  const Sl = (e) => "inline-command" === e.type || "inline-format" === e.type,
    Nl = (e) => "block-command" === e.type || "block-format" === e.type,
    Rl = (e) => {
      var t;
      const n = (t) => _l.error({ message: t, pattern: e }),
        o = (t, o, r) => {
          if (void 0 !== e.format) {
            let r;
            if (p(e.format)) {
    ...
    Ul = (e, t) => e.dispatch("PastePlainTextToggle", { state: t }),
    zl = xt().deviceType,
    jl = zl.isTouch(),
    Hl = ma.DOM,
    $l = (e) => u(e, RegExp),
    ...
    xd = Vl("content_style"),
    _d = Vl("font_css"),
    kd = Vl("directionality"),
    Sd = Vl("inline_boundaries_selector"),
    ...
    xc = Vl("text_patterns"),
    _c = Vl("text_patterns_lookup"),
    kc = Vl("noneditable_class"),
    Sc = Vl("editable_class"),
    ...
    Wc = (e) => {
      let t;
      for (; -1 !== (t = e.data.lastIndexOf(ei)); ) e.deleteData(t, 1);
    },
    Kc = (e, t) => (Gc(e), t),
    Yc = (e, t) =>
      el.isTextPosition(t)
              ...
              ? ((e, t) => {
                  const n = t.container(),
                    o = ((e, t) => {
                      ...
                      .map((e) => (e < t.offset() ? el(n, t.offset() - 1) : t))
                      .getOr(t);
                  return Gc(e), o;
                })(e, t)
              : Kc(e, t))(e, t),
            ...
            return (
              (a = ((e, t) => {
                ...
                if (t) {
                  ...
                  if (ri(t)) {
                    if (ii(t)) return t;
                    if (mi(t)) return t.splitText(t.data.length - 1);
                  }
                  ...
                  if (ri(t)) {
                    if (ii(t)) return t;
                    if (ui(t)) return t.splitText(1), t;
                  }
                  e.nextSibling
    ...
    hu = (e, t, n, o, r) => {
      ...
      let i;
      if (gu(t)) {
        if (a && ((i = pu(s.prev.bind(s), !0)), n(i))) return i;
        for (; (i = pu(s.prev.bind(s), r)); ) if (n(i)) return i;
      }
      if (fu(t)) {
        if (a && ((i = pu(s.next.bind(s), !0)), n(i))) return i;
        for (; (i = pu(s.next.bind(s), r)); ) if (n(i)) return i;
      }
      return null;
    },
    bu = (e, t) => {
    ...
    Eu = (e, t, n) => {
      ...
      for (; r && r !== t; ) {
        let e = r[o];
        if ((e && lu(e) && (e = e[o]), su(e) || au(e))) {
          if (wu(t, e, r)) return e;
          break;
        }
        if (mu(e)) break;
        r = r.parentNode;
    ...
    ku = (e, t, n) => {
      ...
      if (si(a)) {
        ...
        if ("before" === t && ((o = e.nextSibling), ou(o))) return xu(o);
        if ("after" === t && ((o = e.previousSibling), ou(o))) return _u(o);
      }
      if (!n.collapsed) return n;
      if (lr(a)) {
        if (lu(a)) {
          if (1 === e) {
            if (((o = s(a)), o)) return xu(o);
            if (((o = r(a)), o)) return _u(o);
          }
          if (-1 === e) {
            if (((o = r(a)), o)) return _u(o);
            if (((o = s(a)), o)) return xu(o);
        ...
        if (mi(a) && i >= a.data.length - 1)
          return 1 === e && ((o = s(a)), o) ? xu(o) : n;
        if (ui(a) && i <= 1) return -1 === e && ((o = r(a)), o) ? _u(o) : n;
        if (i === a.data.length) return (o = s(a)), o ? xu(o) : n;
        if (0 === i) return (o = r(a)), o ? _u(o) : n;
      }
      return n;
    },
    Su = (e, t) => yu(e ? 0 : -1, t).filter(su),
    Nu = (e, t, n) => {
      const o = ku(e, t, n);
    ...
    Mu = (e) =>
      ...
      ((e) =>
        !!Li(e) &&
        !X(ce(e.getElementsByTagName("*")), (e, t) => e || Si(t), !1))(e),
    Iu = Mi,
    Fu = (e, t) =>
    ...
    Uu = (e, t) => {
      if (fu(e)) {
        if (Lu(t.previousSibling) && !Bu(t.previousSibling))
          return el.before(t);
        if (Bu(t)) return el(t, 0);
      }
      if (gu(e)) {
        if (Lu(t.nextSibling) && !Bu(t.nextSibling)) return el.after(t);
        if (Bu(t)) return el(t, t.data.length);
      }
    ...
    zu = (e, t, n) => {
      ...
      let l = a.offset();
      if (Bu(i)) {
        if (gu(e) && l > 0) return el(i, --l);
        if (fu(e) && l < i.length) return el(i, ++l);
        o = i;
      } else {
        if (gu(e) && l > 0 && ((r = Fu(i, l - 1)), Lu(r)))
          return !Mu(r) && ((s = hu(r, e, Iu, r)), s)
            ? Bu(s)
              ? el(s, s.data.length)
              : el.after(s)
            : Bu(r)
            ? el(r, r.data.length)
            : el.before(r);
        if (fu(e) && l < i.childNodes.length && ((r = Fu(i, l)), Lu(r)))
          return Du(r)
            ? ((e, t) => {
      ...
      if (
        o &&
        ((fu(e) && a.isAtEnd()) || (gu(e) && a.isAtStart())) &&
        ((o = hu(o, e, M, n, !0)), Iu(o, n))
      )
        return Uu(e, o);
      r = o ? hu(o, e, Iu, n) : o;
      const d = De(
      ...
      return !d || (r && d.contains(r))
        ? r
          ? Uu(e, r)
          : null
        : ((a = fu(e) ? el.after(d) : el.before(d)), a);
    },
    ju = (e) => ({ next: (t) => zu(1, t, e), prev: (t) => zu(-1, t, e) }),
    ...
    Wu = (e, t, n) =>
      qu(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !Vu(t, n) &&
                ((o = t), !(!el.isTextPosition(o) && gr(o.getNode()))) &&
                $u(t) &&
                Hu(n)
            : !Vu(n, t) && Hu(t) && $u(n);
          var o;
    ...
    Yu = (e, t) => {
      ...
      return lr(n)
        ? I.some(el(n, e ? 0 : n.data.length))
        : n
        ? Di(n)
          ? I.some(e ? el.before(n) : gr((o = n)) ? el.before(o) : el.after(o))
          : ((e, t, n) => {
  ...
  const hm = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Gm = (e) =>
      ((e) => {
        ...
        let n = e;
        for (; n; ) {
          if ((lr(n) && n.data !== ei) || n.childNodes.length > 1) return [];
    ...
    sf = (e, t, n, o, r, s) => {
      ...
      return d(n, o, of)
        .bind((e) =>
          s ? d(e.container, e.offset + (r ? -1 : 0), rf) : I.some(e)
        )
        .orThunk(() =>
    ...
    mf = (e, t, n, o = {}) => {
      ...
      const m = n[0];
      return (
        Jo(l) && l.hasChildNodes() && ((l = xi(l, d)), lr(l) && (d = 0)),
        Jo(c) &&
          c.hasChildNodes() &&
          ((c = xi(c, t.collapsed ? u : u - 1)), lr(c) && (u = c.data.length)),
        (l = tf(e, l)),
        (c = tf(e, c)),
        uf(l) &&
        ...
        (Km(m) || m.block_expand) &&
          ((Km(m) && lr(l) && 0 !== d) || (l = cf(e, n, l, d, !0, s)),
          (Km(m) && lr(c) && u !== c.data.length) ||
            (c = cf(e, n, c, u, !1, s))),
        Ym(m) &&
          ((l = af(e, n, t, l, "previousSibling")),
          (c = af(e, n, t, c, "nextSibling"))),
        (qm(m) || Wm(m)) &&
          ((l = lf(e, n, l, "previousSibling")),
          (c = lf(e, n, c, "nextSibling")),
          qm(m) &&
            (e.isBlock(l) || ((l = cf(e, n, l, d, !0, s)), lr(l) && (d = 0)),
            e.isBlock(c) ||
              ((c = cf(e, n, c, u, !1, s)), lr(c) && (u = c.data.length)))),
        Jo(l) && l.parentNode && ((d = e.nodeIndex(l)), (l = l.parentNode)),
        Jo(c) && c.parentNode && ((u = e.nodeIndex(c) + 1), (c = c.parentNode)),
    ...
    vf = (e) => {
      ...
      ((e, t) => {
        const n = xa(),
          ...
          r = (e) => {
            var t, n;
            e.attr(_a(), null), e.attr(xa(), null), e.attr(ka(), null);
      ...
      ((e, t) =>
        ((e) =>
          e.collapsed
            ...
            : I.none())(t).bind((t) =>
          Ga(t) ? I.some(t) : Sn(e, t) ? I.none() : I.some(e)
        ))(Cn(e.getBody()), t)
        .bind((e) => Zu(e.dom))
        .fold(
          () => {
  ...
  const lg = (e, t) => {
    ...
    Cg = (e, t, n, o, r) => {
      ...
      if (o && gr(r) && t && e.isEmpty(c)) return I.some(el(i, e.nodeIndex(r)));
      const u = new $o(r, c);
      for (; (d = u[o ? "prev" : "next"]()); ) {
  ...
  const np = Dt.makeMap(
    ...
    bp = (e, t, n) => {
      ...
      return (
        (o =
          "raw" === t.format
            ? Dt.trim(ni(gp(n, e.serializer.getTempAttrs()).innerHTML))
            : "text" === t.format
            ? ((e, t) => {
                const n = e.getDoc(),
                  o = $n(Cn(e.getBody())),
  ...
  const xp = ["font", "text-decoration", "text-emphasis"],
    ...
    Ap = (e) => {
      ...
      return (
        lr(t) &&
        (0 === t.data.length || (ti(t.data) && yf.isBookmarkNode(t.parentNode)))
      );
    },
    Tp = (e, t) => (n) =>
      yu(e ? 0 : -1, n)
    ...
    qp = (e, t, n, o) =>
      $p(e, t.dom, n).forall((e) =>
        Vp(t, n, o).fold(
          () => !vu(e, n, t.dom),
          (o) => !vu(e, n, t.dom) && Sn(o, Cn(e.container()))
        )
      ),
    Wp = (e, t, n, o) =>
      Vp(t, n, o).fold(
        () => $p(e, t.dom, n).forall((e) => !vu(e, n, t.dom)),
    ...
    eh = (e, t, n) =>
      ((e) => I.from(e.getNode(!0)).map(Cn))(t).exists(qa) ||
      Qp(!1, e, t, n).isSome(),
    th = T(Qp, !1),
    nh = T(Qp, !0),
    ...
    lh = (e, t) => (n) => {
      return (o = new $o(n, e)[t]()), C(o) && br(o) && iu(o);
      var o;
    },
    dh = (e, t, n) =>
      !ih(t) &&
    ...
    Eh = (e, t) =>
      ((e, t) => {
        ...
        return (
          !el.isTextPosition(e) &&
          n === t.parentNode &&
          o > el.before(t).offset()
        );
      })(t, e)
        ? el(t.container(), t.offset() - 1)
        : t,
    xh = (e) => {
      return Di(e.previousSibling)
        ? I.some(
            ((t = e.previousSibling),
            lr(t) ? el(t, t.data.length) : el.after(t))
          )
        : e.previousSibling
    ...
    _h = (e) => {
      return Di(e.nextSibling)
        ? I.some(((t = e.nextSibling), lr(t) ? el(t, 0) : el.before(t)))
        : e.nextSibling
        ? Zu(e.nextSibling)
        : I.none();
      var t;
        ...
        e
          ? ((e, t) =>
              _h(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    Gu(e, el.after(t)).orThunk(() => Xu(e, el.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              xh(t)
                .orThunk(() => _h(t))
                .orThunk(() =>
                  ((e, t) =>
                    I.from(t.previousSibling ? t.previousSibling : t.parentNode)
                      .bind((t) => Xu(e, el.before(t)))
                      .orThunk(() => Gu(e, el.after(t))))(e, t)
        ...
        return (
          ...
          (d = (e, t, r) => {
            const s = e.dom,
              a = t.dom,
              i = s.data.length;
            return wh(s, a, n, o), r.container() === a ? el(s, i) : r;
          }),
    ...
    Ah = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
    Th = (e, t) => xn(Cn(t), Sd(e)) && !Zr(e.schema, t) && e.dom.isEditable(t),
    Oh = (e) => {
      var t;
      return (
    ...
    Ph = (e, t) => {
      ...
      return e
        ...
        ? lr(n.previousSibling)
          ? el(n.previousSibling, n.previousSibling.data.length)
          : el.before(n)
        : ci(t)
        ? el(n, o - 1)
        : t;
      ...
      if (
        (a.dom === e.getBody()
          ...
          : Tr(e.schema, a, { checkRootAsContent: !1 }) &&
            (Ja(a), o && e.selection.setCursorLocation(a.dom, 0)),
        !kn(n, a))
      ) {
        const t = Lt(Tn(a), n)
          ? []
          : Tn((i = a))
              ...
              .getOr([]);
        q(t.concat(In(n)), (t) => {
          kn(t, a) || Sn(t, a) || !Tr(e.schema, t) || Eo(t);
        });
      }
      var i;
    },
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? Eo(n)
                      : (Ja(n), e.selection.setCursorLocation(n.dom, 0));
                  });
    ...
    fb = (e, t) =>
      I.some(() => {
        Ja(t), e.selection.setCursorLocation(t.dom, 0);
      }),
    gb = (e, t) => (e ? Ip(t) : Fp(t)),
    pb = (e, t, n) => {
    ...
    iv = (e, t, n, o) => {
      ...
      if (h)
        if (l) {
          ...
          c.collapse(!0);
          let s = mf(a, c, d, { includeTrailingSpace: !0 });
    ...
    lv = (e) => {
      const t = ev(!1),
        n = rv(e, t.dom);
      return { caretContainer: t, caretPosition: el(n, 0) };
    },
    dv = (e, t) => {
  ...
  const fv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
    ...
    Nv = kl([{ keep: [] }, { rename: ["name"] }, { removed: [] }]),
    Rv = /^(src|href|style)$/,
    Av = Dt.each,
    Tv = Um,
        ...
        ((n.list_block && Tv(t, n.list_block)) ||
          q(ce(t.childNodes), (t) => {
            Lm(e, a, t.nodeName.toLowerCase())
              ? r
                ? r.appendChild(t)
                : ((r = Dv(s, t, a)), s.setAttribs(r, td(e)))
              : (r = null);
          })),
        ...
        ((e, t, n, o, r) => {
          const s = e.formatter.get(t),
            ...
            f = (t) => {
              let n,
                o,
                r = mf(i, t, s, { includeTrailingSpace: t.collapsed });
              if (a.split) {
                if (
    ...
    Kv = (e, t, n, o) => {
      ...
      if ("false" === i.getContentEditable(g) && !Im(e, g))
        return c(r, (o = g)), void Dl(e, t, o, n);
      if (s) {
        if (o)
          if (Am(o)) {
            if (!c(r, o)) {
  ...
  const EC = (e, t, n, o, r) => {
          ...
          n.addHook("uponSanitizeElement", (e, t) => {
            ...
            const s =
              null !== (n = t.tagName) && void 0 !== n
                ...
                : e.nodeName.toLowerCase();
            if (
              (r && "semantics" === s && (t.allowedTags[s] = !0),
              "annotation" === s)
            ) {
              const n = ((e) => {
    ...
    OC = (e, t, n, o) => {
      ...
      for (let t = 0, r = a.length; t < r; t++) {
        ...
        Mr(i.name) || OC(i, r, n, o), e.append(i);
      }
    },
    BC = (e = {}, t = Fs()) => {
      const n = ty(),
        ...
        g = (e, n) => {
          const o = m(n.attr(CC)),
            r = 1 === n.type && !_e(e, n.name) && !Jr(t, n) && !Mr(n.name);
          return 3 === n.type || (r && !o);
        },
        p = {
          schema: t,
    ...
    LC = (e, t) => {
      if (t.no_events) return _l.value(t);
      {
        const n = ((e, t) => e.dispatch("BeforeGetContent", t))(e, t);
        return n.isDefaultPrevented()
          ? _l.error(Il(e, { content: "", ...n }).content)
          : _l.value(n);
      }
    },
    MC = (e, t, n) => {
      ...
      {
        const o = PC(t, (t) => Il(e, { ...n, content: t }), DC(e));
        return o.content;
      }
    },
    IC = (e, t) => {
      if (t.no_events) return _l.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? (Ml(e, n), _l.error(void 0))
          : _l.value(n);
      }
    },
    FC = (e, t, n) => {
      n.no_events || Ml(e, { ...n, content: t });
    },
    ...
    ow = (e) => {
      ...
      return ((e) => null !== e.querySelector("iframe"))(n)
        ? {
            type: "fragmented",
            fragments: Y(V(ce(n.childNodes), k(ni, ew)), (e) => e.length > 0),
            content: "",
            bookmark: null,
            beforeBookmark: null,
          }
        ...
        return e.map((e) =>
          ((e, t, n) => {
            Tn(e).each((o) => {
              ...
              t && ch(o, el(r, 0), n)
                ? yh(r, 0, n)
                : !t && uh(o, el(r, r.length), n) && Ch(r, r.length, n);
            });
          })(e, o, r)
        );
      });
  ...
  const yw = (e) => !(!e || !e.ownerDocument) && Sn(Cn(e.ownerDocument), Cn(e)),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        f = {
          ...
          getBoundingClientRect: () => {
            const e = c();
            return e.collapsed
              ? el.fromRangeStart(e).getClientRects()[0]
    ...
    Qw = (e, t, n) => {
      Pl(e, t, { message: n }), console.error(n);
    },
    Jw = (e, t, n) =>
      n
    ...
    uE = (e, t) => {
      ...
      return V(t, (t) =>
        ((e) => trendymc.Resource.has(cE(e)))(t)
          ? t
  ...
  const pE = (e, t) => {
    ...
    jE = (e, t, n, o, r) => {
      if (Tr(o, n)) return Ja(n), Zu(n.dom);
    ...
    WE = (e, t) => {
      const n = Cn(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
            ? ((e, t, n, o) => {
                const r = IE(t, el.fromRangeStart(o)),
                  s = r.bind((o) =>
                    qu(n, t, o.position).bind((o) =>
                      IE(t, o).map((o) =>
                        ((e, t, n, o) =>
                          gr(o.position.getNode()) && !Tr(e, o.block)
                            ? Yu(!1, o.block.dom)
                                .bind((e) =>
    ...
    QE = (e, t, n) =>
      t.collapsed
        ? ((e, t, n) => {
            const o = ku(1, e.getBody(), t),
              r = el.fromRangeStart(o),
              s = r.getNode();
            if (nu(s)) return XE(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if (nu(a)) return XE(1, e, a, !1, !1);
            const i = bb(e.dom.getRoot(), r.getNode());
            return nu(i) ? XE(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    JE = (e) => Up(e) || Lp(e),
    ex = (e) => zp(e) || Mp(e),
    ...
    rx = (e) => {
      ...
      return (
        !t.collapsed &&
        (ox(e, !0).exists((e) => e.isEqual(el.fromRangeStart(t))) ||
          ox(e, !1).exists((e) => e.isEqual(el.fromRangeEnd(t))))
      );
    },
    sx = kl([
      { remove: ["element"] },
    ...
    ax = (e, t, n, o) =>
      qu(t, e, n).bind((r) => {
        return (
          ...
          ((e, t, n, o, r) => {
            const s = (t) =>
              r.isInline(t.nodeName.toLowerCase()) && !vu(n, o, e);
            ...
            ? ((e, t, n, o, r) => {
                ...
                return zh(Cn(t), Cn(o.getNode()))
                  .map((t) =>
                    Tr(e, t) ? sx.remove(t.dom) : sx.moveToElement(s)
                  )
    ...
    dx = (e) => {
      ...
      if (hr(o) && t.isBlock(o) && t.isEmpty(o)) {
        ...
        t.setHTML(o, ""), o.appendChild(e), n.setRng(el.before(e).toRange());
      }
      return !0;
    },
    cx = (e, t) =>
    ...
    hx = (e, t) =>
      e.selection.isCollapsed()
        ...
        : I.none(),
    bx = lr,
    vx = (e) => bx(e) && e.data[0] === ei,
    yx = (e) => bx(e) && e.data[e.data.length - 1] === ei,
    Cx = (e) => {
      var t;
      return (
      ...
      e
        ? ((e) => {
            ...
            if (bx(e.previousSibling))
              return (
                yx(e.previousSibling) || e.previousSibling.appendData(ei),
                e.previousSibling
              );
            if (bx(e)) return vx(e) || e.insertData(0, ei), e;
            {
              const n = Cx(e);
              return (
                null === (t = e.parentNode) ||
        ...
        : ((e) => {
            ...
            if (bx(e.nextSibling))
              return (
                vx(e.nextSibling) || e.nextSibling.insertData(0, ei),
                e.nextSibling
              );
            if (bx(e)) return yx(e) || e.appendData(ei), e;
            {
              const o = Cx(e);
              return (
                e.nextSibling
    ...
    Sx = (e, t) =>
      t.fold(
        (t) => {
          Gc(e.get());
          const n = Ex(t);
          return e.set(n), I.some(el(n, n.length - 1));
        },
        (t) =>
          Zu(t).map((t) => {
            if (kx(t, e)) {
        ...
        (t) =>
          Qu(t).map((t) => {
            ...
            }
            {
              Gc(e.get());
              const n = _x(t, !1);
              return e.set(n), el(n, n.length - 1);
            }
          }),
        (t) => {
          Gc(e.get());
          const n = xx(t);
          return e.set(n), I.some(el(n, 1));
        }
      ),
    Nx = (e, t) => {
      for (let n = 0; n < e.length; n++) {
    ...
    qx = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
        t.setRng(el(n.container(), n.offset() + o).toRange()),
  ...
  const Kx = (e, t) => (-1 === e ? oe(t) : t),
    Yx = (e, t, n) => (1 === e ? t.next(n) : t.prev(n)),
    Gx = (e, t, n, o) =>
      gr(o.getNode(1 === t)) ? Wx.Br : !1 === vu(n, o) ? Wx.Block : Wx.Wrap,
    Xx = (e, t, n, o) => {
      const r = ju(n);
      let s = o;
      const a = [];
    ...
    e_ = T(Xx, el.isAbove, -1),
    t_ = T(Xx, el.isBelow, 1),
    n_ = T(Zx, -1, e_),
    o_ = T(Zx, 1, t_),
  ...
  const p_ = (e, t, n, o, r, s) => {
      ...
      return (
        c &&
          ...
          ((e, t, n, o) => {
            let r = o;
            for (; (r = hu(r, e, Mi, t)); ) if (n(r)) return;
          })(e, o, l, c)),
        i
      );
    },
    h_ = T(p_, g_.Up, yi, Ci),
    b_ = T(p_, g_.Down, Ci, yi),
    ...
    __ = (e, t, n, o, r, s) => {
      ...
      let g;
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ei(n)), g)) {
        const n = ((e, t, n, o) => {
          const r = ju(t);
          let s, a, i, l;
          const d = [];
          let c = 0;
          e === g_.Down
            ? ((s = r.next), (a = Ci), (i = yi), (l = el.after(o)))
            : ((s = r.prev), (a = yi), (i = Ci), (l = el.before(o)));
          const u = v_(l);
          do {
    ...
    F_ = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          Ih(e),
          Ix(s, r, el.fromRangeStart(e.selection.getRng()))
            .map(jx)
            .bind(I_(e, t))
            .each(D);
      }),
    ...
    dk = (e, t) =>
      !!lr(t) ||
      (!!Jo(t) && !(lk(e.getBlockElements(), t) || fm(t) || Zr(e, t) || Ir(t))),
    ck = (e, t) => {
      if (lr(t)) {
        if (0 === t.data.length) return !0;
        if (/^\s+$/.test(t.data))
          return !t.nextSibling || lk(e, t.nextSibling) || Ir(t.nextSibling);
      }
      return !1;
    },
    uk = (e) => e.dom.create(ed(e), td(e)),
    mk = (e, t, n) => {
      const o = Cn(uk(e)),
        r = Qa();
      vo(o, r), n(t, o);
    ...
    bk = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ...
          : void (li(n) && (hk(e, n), e.undoManager.add()));
    },
    vk = br,
    yk = (e, t, n) => {
    ...
    Bk = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return x_(e, n, o, Lp, Mp, wr).exists((t) => (w_(e, t), !0));
    },
    Pk = (e, t) => {
      const n = t ? 1 : -1,
        o = e.selection.getRng();
      return __(e, n, o, Lp, Mp, wr).exists((t) => (w_(e, t), !0));
    },
          ...
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) =>
                Qx(n_(e, el.before(t)), n.left)
              )
            )
            .getOr(el.before(t)))(a, n, s);
        return Xk(e, t, o), !0;
      }
      if (t && Yk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => Qx(o_(e, el.after(t)), n.left))
            )
            .getOr(el.after(t)))(a, n, s);
        return Xk(e, t, o), !0;
      }
      return !1;
    },
            ...
            return {
              extract: (n, o) => {
                ...
                for (const s of e) {
                  ...
                  if (e.stype === vS.Value)
                    return { stype: vS.Value, svalue: t(e.svalue) };
                  r.push(e);
                }
                return TS(r);
              },
  ...
  const ON = (e) => {
    ...
    eR = (e, t) => {
      ed(e).toLowerCase() === t.tagName.toLowerCase() &&
        ((e, t, n) => {
          const o = e.dom;
          I.from(n.style)
            .map(o.parseStyle)
    ...
    uR = (e, t, n) =>
      lr(t)
        ? e
          ? 1 === n && t.data.charAt(n - 1) === ei
            ? 0
            : n
          : n === t.data.length - 1 && t.data.charAt(n) === ei
          ? t.data.length
          : n
        : n,
    mR = {
      insert: (e, t) => {
        ...
        else if (si(k)) (R = fi(k)), i.isEmpty(k) && JN(k), eR(e, R), XN(e, R);
        else if (v(!1)) R = w();
        else if (v(!0) && N) {
    ...
    $R = (e, t) => e === t || e.contains(t),
    VR = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return lr(n)
        ? (n.insertData(o, e), I.some(el(n, o + e.length)))
        : Ru(t).map((n) => {
            const o = yn(e);
            return t.isAtEnd() ? ho(n, o) : po(n, o), el(o.dom, e.length);
          });
    },
    qR = T(VR, qo),
    WR = T(VR, " "),
        ...
        return Ix(o, e.getBody(), r)
          .bind(
            (
              (e) => (t) =>
                t.fold(
                  (t) => Xu(e.dom, el.before(t)),
                  (e) => Zu(e),
                  (e) => Qu(e),
                  (t) => Gu(e.dom, el.after(t))
                )
            )(n)
          )
          .map(
      ...
      return Ft(
        ...
        () => {
          ...
          e.selection.isCollapsed() || e.getDoc().execCommand("Delete"),
            ((e, t, n) => (dh(e, t, n) ? qR(t) : WR(t)))(
              t,
              el.fromRangeStart(e.selection.getRng()),
              e.schema
            ).each(KR(e));
        }
      );
            ...
            e.on("beforeinput", (t) => {
              (e.selection.isEditable() &&
                !$(
                  ...
                  (t) =>
                    !((e, t) =>
                      !$R(e.getBody(), t.startContainer) ||
                      !$R(e.getBody(), t.endContainer) ||
                      qg(e.dom, t))(e, t)
                )) ||
                t.preventDefault();
            });
                ...
                ((e, t) => {
                  Ok(
                    [
                      ...
                      { keyCode: Qf.SPACEBAR, action: Ak(GR, e) },
                    ],
                    t
                  ).each((n) => {
                    t.preventDefault(),
  ...
  const JR = La("image"),
    ...
    sA = (e) => {
      const t = e;
      return I.from(t[eA]).exists((e) => 0 === e);
    };
  const aA = La("mode"),
    iA = (e) => (t) => {
      t[aA] = e;
    ...
    mA = (e) => (t) => {
      const n = t;
      return I.from(n[aA]).exists((t) => t === e);
    },
    fA = mA(0),
    gA = mA(1),
    pA = ["none", "copy", "link", "move"],
    hA = [
      "none",
      "copy",
      "copyLink",
    ...
    OA = (e, t) => (e.insertContent(t, { merge: vc(e), paste: !0 }), !0),
    BA = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    PA = (e, t, n) =>
      !(e.selection.isCollapsed() || !BA(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    DA = (e, t, n) =>
      !!((e, t) =>
        BA(t) && $(Bc(e), (e) => Ve(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
    ...
    jA = (e, t) => t in e && e[t].length > 0,
    HA = (e) => jA(e, "text/html") || jA(e, "text/plain"),
    $A = (e, t, n) => {
          ...
          (s =
            jA(t, "text/plain") && i
              ...
              : ((e) => {
                  ...
                  return (e = RA(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o;
                })(s)),
        NA(s) || (o ? UA(e, s, r) : FA(e, s, a, r));
    },
    qA = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on("keydown", (e) => {
          ...
          e.on("paste", (r) => {
            ...
            o = !1;
            const a = zA(r.clipboardData);
            (!HA(a) && $A(e, r, t.getLastRng() || e.selection.getRng())) ||
              (jA(a, "text/html")
                ? (r.preventDefault(), VA(e, a, a["text/html"], s, !0))
                : jA(a, "text/plain") && jA(a, "text/uri-list")
                ? (r.preventDefault(), VA(e, a, a["text/plain"], s, !0))
                : (t.create(),
                  Uf.setEditorTimeout(
                    e,
                    () => {
                      const n = t.getHtml();
                      t.remove(), VA(e, a, n, s, !1);
                    },
                    0
                  )));
          });
    ...
    YA = (e) => ({
      html: EA(e.selection.getContent({ contextual: !0 })),
    ...
    QA = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    JA = (e) => Dt.trim(e).replace(QA, Ws).toLowerCase(),
    eT = (e, t, n) => {
      const o = hc(e);
      if (n || "all" === o || !bc(e)) return t;
      const r = o ? o.split(/[, ]/) : [];
      if (r && "none" !== o) {
        const n = e.dom,
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (kA(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = kA(e)); ) n.remove(o), n.unbind(o);
        ...
        ((e, t) => {
          e.addCommand("mceTogglePlainTextPaste", () => {
            ...
            e.addCommand("mceInsertClipboardContent", (t, n) => {
              n.html && FA(e, n.html, n.internal, !1),
          ...
          ((e) => {
            e.on(
              ...
              e.on(
                "copy",
                ((e) => (t) => {
                  !t.isDefaultPrevented() && GA(e) && WA(t, YA(e), KA(e), _);
                })(e)
              );
          })(e),
            ((e, t) => {
              uc(e) &&
                ...
                e.on("drop", (n) => {
                  ...
                  (d && !l) ||
                    (i &&
                      ...
                      Uf.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          (a || (d && l)) && e.execCommand("Delete"), ZA(e, o);
                          const t = AA(i);
                          r["text/html"] ? FA(e, t, s, !0) : UA(e, t, !0);
                        });
                      })));
                }),
                e.on("dragstart", (e) => {
                ...
                e.on("dragover dragend", (n) => {
                  mc(e) && !t.get() && (n.preventDefault(), ZA(e, XA(e, n))),
                  ...
                  e.on("input", (t) => {
                    ...
                    if ("deleteByDrag" === t.inputType) {
                      ...
                      q(t, (t) => {
                        ...
                        n.appendChild(Qa().dom), t.prepend(n);
                      });
                    }
                  });
                })(e);
    ...
    rT = (e) => br(e.dom),
    sT = (e) => (t) => kn(Cn(e), t),
    aT = (e, t) => Zn(Cn(e), rT, sT(t)),
    iT = (e, t, n) => {
      const o = new $o(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !nT(t); t = r()) Di(t) && (s = t);
      return s;
    },
    lT = (e) => {
      const t = ((e, t, n) => {
        ...
        return (
          aT(s, r).fold(
            () => {
              oT(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            (e) => i.setStartBefore(e.dom)
          ),
          aT(a, r).fold(
            () => {
              oT(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
  ...
  const cT = (e, t) => Math.abs(e.left - t),
    uT = (e, t) => Math.abs(e.right - t),
    mT = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    pT = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: cT(e, t) < uT(e, t) ? dT.Before : dT.After,
          }))(e, t)
        ),
    hT = (e) => {
      var t, n;
    ...
    vT = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...bT(n) }))(
            e,
            o,
            t,
            r
    ...
    RT = (e, t, n, o, r) => {
      "dragstart" === t && vA(o, e.dom.getOuterHTML(n));
      const s = vT(t, n, o, r);
    ...
    AT = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (!e.dragging && s > 10) {
            const n = RT(t, "dragstart", e.element, e.dataTransfer, r);
            if (
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? hT(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = hT(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
                  ...
                  e.intervalId.clear(),
                    e.dragging &&
                      ...
                      (a + 8 >= g
                        ...
                        : b - 16 <= 0 && e.intervalId.set(xT(window)));
                });
              })(
                e.ghost,
                l,
    ...
    TT = (e, t, n) => {
      e.on((e) => {
        e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => RT(t, "dragend", e.element, e.dataTransfer),
              (n) => RT(t, "dragend", e.element, e.dataTransfer, n)
            );
      }),
        OT(e);
    },
    ...
    BT = (e) => {
      const t = Dr(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            const o = Q(t.dom.getParents(n.target), CT).getOr(null);
            if (
              C(o) &&
              ((e, t, n) => yT(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
              ...
              e.set({
                ...
                ghost: wT(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: Pr(100),
              });
            }
          }
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            ...
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ...
                const r =
                  ...
                  void 0 !== o
                    ? o
                    : t.getBody();
                RT(t, "drop", r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    ((e, t) => {
              ...
              RT(t, "dragend", t.getBody(), e.dataTransfer, n);
            }
          }),
            OT(e);
        })(t, e),
      ...
      e.on("mousedown", r),
        ...
        e.on("keydown", (n) => {
          n.keyCode === Qf.ESC && TT(t, e, I.none());
        });
    },
    PT = br,
    DT = (e, t) => bb(e.getBody(), t),
    LT = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
          ...
          if (r.collapsed) {
            if (!u(r)) {
              const e = c ? 1 : -1,
                ...
                s = t.getNode(!c);
              if (C(s)) {
                if (ou(s)) return d(e, s, !!c && !t.isAtEnd(), !1);
              ...
              const a = t.getNode(c);
              if (C(a)) {
                if (ou(a)) return d(e, a, !c && !t.isAtEnd(), !1);
      ...
      return (
        mw(e) ||
          ...
          e.on("mousedown", (r) => {
            ...
            PT(a)
              ...
              : pT(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === dT.Before, !1)) &&
                      t.setRng(o),
                    er(a) ? a.focus() : e.getBody().focus();
                });
          }),
          e.on("keypress", (e) => {
            Qf.modifierPressed(e) || (PT(t.getNode()) && e.preventDefault());
          }),
          ...
          })(e)),
        {
          ...
          showBlockCaretContainer: (e) => {
            e.hasAttribute("data-mce-caret") && (fi(e), t.scrollIntoView(e));
          },
          hideFakeCaret: p,
          destroy: () => {
            r.destroy(), (i = null);
    ...
    jT = (e, t, n) => {
      if (t && e.isEmpty(t) && !n(t)) {
        const o = t.parentNode;
        e.remove(t, lr(t.firstChild) && Yo(t.firstChild.data)), jT(e, o, n);
      }
    },
    HT = (e, t, n, o = !0) => {
    ...
    $T = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    VT = (e, t, n) => {
    ...
    WT = (e, t) => e.create("span", { "data-mce-type": "bookmark", id: t }),
    KT = (e, t) => {
      const n = e.createRng();
      return n.setStartAfter(t.start), n.setEndBefore(t.end), n;
    },
    YT = (e, t, n) => {
      const o = zT(e.getRoot(), n).getOrDie("Unable to resolve path range"),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(WT(e, t + "-end"), a),
        start: l.insertBefore(WT(e, t + "-start"), i),
      };
    },
    GT = (e, t, n) => {
      jT(e, e.get(t.prefix + "-end"), n), jT(e, e.get(t.prefix + "-start"), n);
    },
      ...
      return uS(
        ...
        }
        {
          ...
          return dS(o.container, s, n)
            ...
            .orThunk(() => ZT(e, t, n, sS(o.container, 0)));
        }
      });
    },
    QT = (e, t, n, o) => {
      ...
      return dS(i, l - n.pattern.end.length, t).bind((d) => {
        const c = FT(r, s, d.container, d.offset, i, l, o);
        if (XT(a))
          return I.some({
        ...
        {
          const i = JT(e, n.remainingPatterns, d.container, d.offset, t, o),
    ...
    JT = (e, t, n, o, r, s) => {
      ...
      return lS(n, o, a.getRoot()).bind((i) => {
        ...
        for (let a = 0; a < t.length; a++) {
          ...
          if (u.isNone() && o > 0) return JT(e, t, n, o - 1, r, s);
    ...
    tO = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        JT(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        JT(
    ...
    rO = (e) => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = zT(o.getRoot(), n.range).getOrDie("Unable to resolve path range");
      return (
        $T(t, s).each((n) => {
          "block-format" === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map((e) =>
              t && Dt.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: FT(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    lO = sO((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    dO = aO(lO, !0),
    cO = rO(oO),
    uO = sO((e, t, n) => t === e.start || n === e.start),
    mO = aO(uO, !1),
    fO = (e, t, n) => {
    ...
    gO = (e) => {
                ...
                ((e, t) => {
                  ...
                  return $T(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: tO(e, o, n.startContainer, s, a, !0),
                        blockMatches: dO(e, o, a, !0),
                      };
                    })
                    .filter(
                  ...
                  ({ inlineMatches: t, blockMatches: n }) => (
                    ...
                    e.undoManager.extra(
                      ...
                      () => {
                        ((e) => {
                          e.insertContent(ei, { preserve_zwsp: !0 });
                        })(e),
                          nO(e, t),
                          ((e, t) => {
                            if (0 === t.length) return;
                    ...
                    return $T(e, n)
                      .map((o) => {
                        const r = Math.max(0, n.startOffset),
                          s = qT(e.dom, o, n.startContainer, r),
                          a = VT(t, o, s);
                        return mO(e, o, a, !1, s);
                      })
                      .filter((e) => e.length > 0);
      ...
      e.on("keyup", (e) => {
        fO(n, e, (e, t) => e === t.keyCode && !Qf.modifierPressed(t)) && s();
      }),
        e.on("keypress", (n) => {
    ...
    hO = ma.DOM,
    bO = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    vO = (e) => Ce(e, (e) => !1 === v(e)),
    yO = (e) => {
    ...
    wO = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    EO = (e) => {
      const t = wO(e),
        n = _d(e),
        o = e.contentCSS,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                trendymc.Resource.has(cE(e))
              ),
              s = o.map((t) => {
                const n = trendymc.Resource.get(cE(t));
                return m(n)
                  ? Promise.resolve(wO(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, wO(e).loadAll(r)];
    ...
    _O = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (hO.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        !jc(e) &&
          e.hasEditableRoot() &&
          (e.inline &&
            "static" === hO.getStyle(o, "position", !0) &&
        ...
        (e.formatter = AE(e)),
        (e.undoManager = OE(e)),
        (e._nodeChangeDispatcher = new QR(e)),
        (e._selectionOverrides = LT(e)),
        ((e) => {
          const t = Dr(),
            n = Br(!1),
            o = wa((t) => {
            ...
            e.on("BeforeSetContent", (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ("raw" !== n.format) {
                  for (; o--; ) r = r.replace(t[o], gk(e, r, kc(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        mw(e) ||
          (((e) => {
            e.on("mousedown", (t) => {
              t.detail >= 3 && (t.preventDefault(), lT(e));
            });
          })(e),
          ((e) => {
            gO(e);
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          dc(e) ||
            ((t.body.spellcheck = !1), hO.setAttrib(n, "spellcheck", "false")),
          (e.quirks = pO(e)),
          ((e) => {
              ...
              "INVALID" !==
                ((e) =>
                  ...
                  ((e) => e.length >= 64 && e.length <= 255)(e)
                    ...
                    : "INVALID")(t)) ||
            console.warn(
              "TrendyMC is running in evaluation mode. Provide a valid license key or add license_key: 'gpl' to the init config to agree to the open source license terms. Read more at https://www.tiny.cloud/license-key/"
            );
        })(e),
        s.fold(
          () => {
          ...
          (t) => {
            e.setProgressState(!0),
              EO(e).then(() => {
                t().then(
                  (t) => {
                    e.setProgressState(!1), xO(e), pw(e);
                  },
                  (t) => {
                    e.notificationManager.open({
                      type: "error",
    ...
    SO = ma.DOM,
    NO = ma.DOM,
    RO = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    AO = (e) => {
      const t = e.getElement();
      return e.inline
        ? RO(null)
        : ((e) => {
            const t = NO.create("div");
            return NO.insertAfter(t, e), RO(t, t);
          })(t);
    },
    TO = async (e) => {
              ...
              if (((n = Dt.trim(n)), o && -1 === Dt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    ...
                    Pl(e, "PluginLoadError", { message: o }),
                      eE(o, n),
                      Zw(e, o);
                  })(e, n, t);
                }
              ...
              ((e, t) => {
                ...
                ((e) => {
                  const t = e.iframeElement,
                    n = () => {
                      (e.contentDocument = t.contentDocument), _O(e);
                    };
    ...
    DO = (e, t) => {
      ...
      ((e, t) => {
        ...
        ((e, t) => {
          ...
          pe(Jd(e), (t, o) => {
            n(o, t), e.options.set("plugins", Qd(e).concat(o));
          }),
            q(Qd(e), (e) => {
              !(e = Dt.trim(e)) ||
                Kw.urls[e] ||
    ...
    $O = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: jO(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = UO(["mobile"], NS(a, r)),
        l = Dt.extend(
          n,
          ...
          ((e, t) => e && zO(t, "mobile"))(e, i)
            ...
            : {},
          { external_plugins: HO(o, i.options()) }
        );
      return ((e, t, n, o) => {
        const r = FO(n.forced_plugins),
          s = FO(o.plugins),
          a = ((e, t) => (zO(e, t) ? e.sections()[t] : {}))(t, "mobile"),
          i = ((e, t, n, o) => (e && zO(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? FO(a.plugins) : s
          ),
          l = ((e, t) => [...FO(e), ...FO(t)])(r, i);
    ...
    qO = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n, o) => {
            ...
            return (
              (n = ch(r, el.fromRangeStart(t), o)
                ? n.replace(/^ /, "&nbsp;")
                : n.replace(/^&nbsp;/, " ")),
              uh(r, el.fromRangeEnd(t), o)
                ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
                : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
            );
    ...
    KO = { "font-size": "size", "font-family": "face" },
    YO = Zt("font"),
    GO = (e) => (t, n) =>
      I.from(n)
        .map(Cn)
          ...
          ((e, t, n) =>
            Vb(
              ...
              (t) =>
                ((t) =>
                  mo(t, e).orThunk(() =>
                    YO(t) ? xe(KO, e).bind((e) => nn(t, e)) : I.none()
                  ))(t),
              (e) => kn(Cn(t), e)
            ))(e, t, n.dom).or(
      ...
      VO(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              WO(e, e.dom.createHTML("img", { src: o }));
            },
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = eB(e, t);
                  e.formatter.toggle("fontname", { value: tB(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: eB(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => JO(e, (t) => ZO(e.getBody(), t.dom)).getOr(""))(e)
                ),
  ...
  class aB {
    ...
    queryCommandState(e) {
      if ((!sB(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const dB = (e) => (
      e._eventDispatcher ||
        (e._eventDispatcher = new lB({
          scope: e,
          toggleEvent: (t, n) => {
            lB.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          },
        })),
      e._eventDispatcher
    ),
    cB = {
      ...
      on(e, t, n) {
        return dB(this).on(e, t, n);
      },
      off(e, t) {
        return dB(this).off(e, t);
      },
      once(e, t) {
        return dB(this).once(e, t);
      },
      hasEventListeners(e) {
        return dB(this).has(e);
      },
    },
    uB = ma.DOM;
  let mB;
  const fB = (e, t) => {
      ...
      const n = Td(e);
      return n
        ? (e.eventRoot || (e.eventRoot = uB.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    gB = (e, t, n) => {
      ((e) => !e.hidden && !sE(e))(e)
    ...
    pB = (e, t) => {
      ...
      if (Td(e)) {
        ...
        const o = (n) => {
          ...
          for (; s--; ) {
            const e = r[s].getBody();
            (e === o || uB.isChildOf(o, e)) && gB(r[s], t, n);
          }
        };
        (mB[t] = o), uB.bind(n, t, o);
      } else {
        const o = (n) => {
          gB(e, t, n);
        };
        uB.bind(n, t, o), (e.delegates[t] = o);
      }
    },
    hB = {
      ...cB,
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(fB(n, e), e, n.delegates[e]),
    ...
    vB = (e, t) => e + (Xe(t.message) ? "" : `. ${t.message}`),
    yB = (e) => e.valid,
    CB = (e, t, n = "") => {
      const o = t(e);
      return b(o)
  ...
  class LB {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t, n = t) => {
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return yB(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  vB(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => _e(o, e);
          ...
          register: (e, n) => {
            const a = ((e) => m(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => CB(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = CB(t, n);
                  if (yB(o)) return o.value;
                  console.error(
                    vB(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("body_id", { processor: Wl(e, "trendymc"), default: "trendymc" }),
            t("body_class", { processor: Wl(e), default: "" }),
          ...
          ((e, t) => {
            ...
            if (r || s || a) {
              const e = "\n- ",
                ...
                l = s ? `\n\nOptions:${e}${n.join(e)}` : "";
              console.warn(
                "The following deprecated features are currently enabled and have been removed in TrendyMC 7.0. These features will no longer work and should be removed from the TrendyMC configuration. See https://www.tiny.cloud/docs/trendymc/7/migration-from-6x/ for more information." +
                  t +
                  i +
                  l
              );
      ...
      C(d) && ma.DOM.styleSheetLoader._setContentCssCors(d),
        ...
        this.setDirty(!1),
        (this.documentBaseURI = new vC(Gl(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = Hd(o)),
        (this.hasVisual = tc(o)),
        (this.shortcuts = new TB(this)),
        (this.editorCommands = new aB(this)),
        oB(this);
    ...
    render() {
      ((e) => {
        ...
        if (!na.Event.domLoaded) return void OO.bind(window, "ready", n);
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            rs.forElement(e, { contentCssCors: Zd(t), referrerPolicy: bd(t) }))(
            o,
            e
          )),
          Hd(e)
    ...
    hasPlugin(e, t) {
      return !(!H(Qd(this), e) || (t && void 0 === Kw.get(e)));
    }
    nodeChanged(e) {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (BB.show(e.getContainer()), BB.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (BB.hide(e.getContainer()),
            BB.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      if (
        ...
        const o = BB.getParent(t.id, "form");
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || BB.get(e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = BB.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
  ...
  const jB = (e) => {
    ...
    HB = (e) => {
      if (e !== UB) {
        const t = ma.DOM;
        e
          ? (t.bind(window, "resize", jB), t.bind(window, "scroll", jB))
          : (t.unbind(window, "resize", jB), t.unbind(window, "scroll", jB)),
          (UB = e);
      }
    },
    $B = (e) => {
      ...
      return (
        (zB = Y(zB, (t) => e !== t)),
        qB.activeEditor === e &&
          (qB.activeEditor = zB.length > 0 ? zB[0] : null),
        qB.focusedEditor === e && (qB.focusedEditor = null),
        t.length !== zB.length
      );
    },
    VB = "CSS1Compat" !== document.compatMode,
    qB = {
      ...cB,
      baseURI: null,
      baseURL: null,
      ...
      setup() {
        ...
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(o) || (o += "/"));
        const r = window.trendymc || window.trendyMCPreInit;
        if (r) (t = r.base || r.baseURL), (n = r.suffix);
          ...
          for (let o = 0; o < e.length; o++) {
            ...
            if (/trendymc(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(r)) {
            ...
            (i = me(
              ((e) =>
                Tt.browser.isIE() || Tt.browser.isEdge()
                  ? (eE(
                      "TrendyMC does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/trendymc/7/support/#supportedwebbrowsers"
                    ),
                    [])
                  : VB
                  ? (eE(
                      "Failed to initialize the editor as the document is not in standards mode. TrendyMC requires standards mode."
                    ),
                    [])
                  : m(e.selector)
      ...
      createEditor(e, t) {
        return this.add(new LB(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : ($B(n) && t.dispatch("RemoveEditor", { editor: n }),
                  0 === zB.length &&
        ...
        } else for (let e = zB.length - 1; e >= 0; e--) t.remove(zB[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
  ...
  const WB = (() => {
    ...
    ZB = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    QB = {
      inflate: (e, t, n) => ZB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: XB,
      ...
      intersect: (e, t) => {
        const n = YB(e.x, t.x),
          o = YB(e.y, t.y),
          r = KB(e.x + e.w, t.x + t.w),
          s = KB(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : ZB(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: ZB,
      fromClientRect: (e) => ZB(e.left, e.top, e.width, e.height),
    },
    JB = (() => {
      const e = {},
        t = {},
      ...
      return {
        load: (n, o) => {
          const r = `Script at URL "${o}" failed to load`,
            s = `Script at URL "${o}" did not call \`trendymc.Resource.add('${n}', data)\` within 1 second`;
  ...
  try {
    ...
    (eP = window.localStorage), eP.setItem(e, e), eP.removeItem(e);
  } catch (e) {
    eP = (() => {
      let e = {},
        t = [];
  ...
  const tP = {
    ...
    nP = Dt.extend(qB, tP);
  ((e) => {
    (window.trendymc = e), (window.trendyMC = e);
  })(nP),
    ((e) => {
