...
!(function () {
  "use strict";
  var e = trendymc.util.Tools.resolve("trendymc.ModelManager");
  const t = (e) => (t) =>
      ((e) => {
        const t = typeof e;
        return null === e
  ...
  let Eo = Zt(() =>
    ...
    })(window.navigator.userAgent, C.from(window.navigator.userAgentData), ko)
  );
  const No = () => Eo(),
    _o = (e, t) => {
      const o = (o) => {
    ...
    $o = (e) => e.cells.length,
    Vo = (e) => {
      const t = _(e, (e) => "colgroup" === e.section);
    ...
    Qo = (e) => {
      ...
      let r = 0,
        s = 0,
        l = 0;
      const { pass: a, fail: c } = _(e, (e) => "colgroup" === e.section);
      N(c, (e) => {
        const a = [];
        N(e.cells, (e) => {
          let o = 0;
    ...
    Pn = ue("tr"),
    In = (e, t, o) => {
      const n = _e(e).getOrThunk(() => at(ke(e)));
      return (t(e) / o(n)) * 100;
    },
    Fn = (e, t) => {
      Nt(e, "width", t + "px");
    ...
    Gn = (e) => In(e, Ao, Wo),
    Kn = (e) => {
      return jn(e) ? Ao(e) : Bo((t = e), "width", t.dom.offsetWidth);
      var t;
    },
    Yn = (e) =>
    ...
    lr = (e, t, o, n) => {
      const r = mn(e),
        ...
        l = [C.some(_n.edge(t))].concat(
          E(_n.positions(r, t), (e) => e.map((e) => e.y))
        );
    ...
    ws = (e, t, o, n, r) => {
      const s = vs(e),
        ...
        a = Re(e, r) ? C.some(n) : ps(s, n);
      return l.bind((e) => a.bind((t) => hs(s, e, t)));
    },
    vs = Xo;
  var ys = [
      "body",
    ...
    xs = () => ({
      up: g({ selector: ht, closest: wt, predicate: ft, all: Be }),
      down: g({ selector: dt, predicate: ct }),
      styles: g({ get: Bt, getRaw: At, set: Nt, remove: Lt }),
      attrs: g({
        get: pe,
        set: ge,
        remove: we,
      ...
      property: g({
        ...
        getText: hr,
        setText: br,
        isBoundary: (e) => !!ce(e) && ("body" === ne(e) || D(ys, ne(e))),
  ...
  const Cs = (e, t, o, n) => {
    ...
    Rs = (e, t) =>
      ((e, t, o) =>
        o.length > 0
          ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, Cs)
          : C.none())(Ts, (t, o) => e(o), t),
    Ds = (e) => ht(e, "table"),
    Os = (e, t, o) => {
      ...
      return Re(e, t)
        ...
        : Ds(e).bind((r) =>
            Ds(t).bind((s) => {
              if (Re(r, s))
                return C.some({ boxes: bs(r, e, t), start: e, finish: t });
              if (De(r, s)) {
    ...
    Es = (e, t, o) =>
      bt(e, t).bind((t) =>
        bt(e, o).bind((e) =>
          Rs(Ds, [t, e]).map((o) => ({ first: t, last: e, table: o }))
        )
      ),
    Ns = (e, t, o, n, r) =>
            ...
            Re(e, o)
              ? ((e, t, o) =>
                  ((e, t, o) =>
                    ...
                    ))(vs(e), t, o))(t.table, t.first, t.last)
              : C.none()
          )
        );
      }),
    ...
    Ls = (e, t, o) =>
      t.length <= 1
        ? C.none()
        : Bs(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({
            bounds: e,
            cells: t,
          })),
    ...
    Is = {
      selected: Ws,
      selectedSelector: "td[" + Ws + "],th[" + Ws + "]",
      firstSelected: Ms,
      firstSelectedSelector: "td[" + Ms + "],th[" + Ms + "]",
      lastSelected: js,
      lastSelectedSelector: "td[" + js + "],th[" + js + "]",
    },
    Fs = (e, t, o) => ({
      element: o,
      mergable: Ls(t, e, Is),
    ...
    Hs = (e) => (t, o) => {
      const n = ne(t),
        r =
          "col" === n || "colgroup" === n
            ? Gt((s = t))
                .bind((e) => _s(e, Is.firstSelectedSelector))
                .fold(g(s), (e) => e[0])
            : t;
      var s;
      return wt(r, e, o);
    ...
    Us = (e, t) => {
      e.on("BeforeGetContent", (t) => {
            ...
            ((e) =>
              Gt(e[0]).map((e) => {
                const t = ((e, t) => {
                  ...
                  N(i, qe),
                    ((e, t, o, n) => {
                      const r = B(e, (e) => "colgroup" !== e.section),
                        s = t.grid.columns,
                        l = t.grid.rows;
                      for (let e = 0; e < l; e++) {
                        let l = !1;
        ...
        if (!0 === t.selection) {
          const t = ((e) => B(qs(e), (e) => Ce(e, Is.selectedSelector)))(e);
          t.length >= 1 && o(t);
        }
      }),
              ...
              Gt(n).each((r) => {
                const s = B(
                    ((e) => {
                      ...
                      return (t.innerHTML = e), Le(xe.fromDom(t));
                    })(o.content),
                    (e) => "meta" !== ne(e)
                  ),
                  l = ue("table");
    ...
    Ks = (e, t, o) =>
      ...
      e.property().isComment(t)
        ? o(t).bind((t) => Ks(e, t, o).orThunk(() => C.some(t)))
        : C.none(),
    Ys = (e, t) =>
      e.property().isText(t)
    ...
    Js = (e, t) => {
      const o = Ks(e, t, e.query().prevSibling).getOr(t);
      if (e.property().isText(o)) return Gs(o, Ys(e, o));
      const n = e.property().children(o);
      return n.length > 0 ? Js(e, n[n.length - 1]) : Gs(o, Ys(e, o));
    },
    Qs = Js,
    Xs = xs(),
    Zs = (e, t) => {
    ...
    sl = () => {
      ...
      return {
        ...
        calcRightEdgeDeltas: (t, o, n, r, s, l) => {
          ...
          {
            const e = nl(t, n, r, s);
            return el(t.slice(0, n)).concat([e]);
          }
        },
    ...
    ll = () => {
      const e = (e, t, o, n, r) => {
        const s = rl(e, n >= 0 ? o : t, n, r);
        return tl(e, t, o + 1, [s, -s], el);
      };
      return {
        resizeTable: (e, t, o) => {
          o && e(t);
    ...
    dl = (e) => {
      ...
      return "tfoot" === e.section
        ? { type: "footer" }
        : t || o
        ? { type: "header", subType: ml(t, o) }
        : { type: "body" };
    },
    ul = (e) => {
      const t = B(e, (e) => cl(e.element));
      return 0 === t.length
        ? C.some("td")
        : t.length === e.length
        ? C.some("th")
    ...
    bl = () => ({
      transformRow: (e, t) => gl(e, "thead" === t ? "tbody" : t),
      transformCell: fl,
    }),
    wl = hl,
    vl = pl,
    ...
    Tl = (e, t) => {
      const o = [],
            ...
            return (
              ...
              N(e.cells, (e) => {
                e.isNew && n.push(e.element),
                  Cl(e.element, "colspan", e.colspan, 1),
                  Cl(e.element, "rowspan", e.rowspan, 1),
                  Ie(t, e.element);
              }),
              t
            );
        ...
        s = (e) =>
          j(e, (e) =>
            E(e.cells, (e) => (Cl(e.element, "span", e.colspan, 1), e.element))
          ),
        l = (t, o) => {
          const n = ((e, t) => {
          ...
          if (!1 === o[r][s]) {
            const m = ((e, t, o, n) => {
              const r = ((e, t) => e[t])(e, t),
                ...
                a = s
                  ? 1
                  : Rl(((e, t) => E(e, (e) => Fo(e, t)))(e.slice(t), o), n);
    ...
    _l = (e, t, o, n, r) => (s, l, a, c) => {
      const i = Xo(s),
        m = C.from(null == c ? void 0 : c.section).getOrThunk(xl);
      return t(i, l)
        .map((t) => {
          const o = ((e, t) => Ol(e, t, !1))(i, a),
            n = e(o, t, Re, r(a), m),
            s = Ko(n.grid);
          return {
            info: t,
        ...
        .bind((e) => {
          const t = Tl(s, e.grid),
            ...
            l = C.from(null == c ? void 0 : c.resize).getOrThunk(ll);
          return (
    ...
    Ll = (e, t) =>
      P(t, (t) => ((e, t) => El(e, t).exists((e) => !e.isLocked))(e, t)),
    Wl = (e, t, o, n) => {
      const r = Vo(e).rows;
      let s = !0;
    ...
    ta = (e, t, o, n, r, s, l) =>
      E(e, (e, a) =>
        ((e) => {
          ...
          return tt(e.element, i, e.section, e.isNew);
        })(e)
      ),
    ...
    na = (e, t, o, n, r) => {
      const s = Vo(e).rows,
        ...
        i = (
          (e, t) => (o, n) =>
            C.some(Zl(e, o.element, "row", t[n]))
        )(o, a);
      return ta(e, l, n, r, ea, i, c);
    },
    ra = (e, t, o, n) => {
      const r = Vo(e).rows,
        s = E(t, (e) => Fo(r[e.row], e.column));
      return ta(e, s, o, n, ea, C.none, x);
    },
    sa = (e) => {
    ...
    pa = (e, t = ga) => {
      const o = (o) => {
        if (fa(o))
          return ua((r = { element: o }).element) ? e.colgroup(r) : e.row(r);
        {
          const r = o,
            s = ((t) => (da(t.element) ? e.col(t) : e.cell(t)))(t(r));
        ...
        i = ((e, t, o, n, r, s, l) => {
          const { cols: a, rows: c } = Vo(e),
            ...
            m = j(t, (e) =>
              ((e, t, o) => {
                const n = e[t];
                return j(n.cells, (n, r) => (Xl(e, t, r, o) ? [] : [n]));
              })(c, e, r)
            ),
            d = E(i.cells, (e, t) => il(oa(c, t, r))),
            u = [...c];
          N(t, (e) => {
          ...
          const f = [...a, ...u],
            ...
            p = (
              (e, t) => (o, n, r) =>
                C.some(Zl(e, o.element, "col", t[r]))
            )(n, d);
          return ta(f, m, r, s, l.transformCell, p, g);
        })(o, c, e, t, r, s.replaceOrInit, l);
      return Oa(i, n[0].row, n[0].column);
    },
    Na = Ea("thead", !0),
    _a = Ea("tbody", !1),
    Ba = Ea("tfoot", !1),
    ...
    Pa = (e) => (t, o) =>
      zl(t, o)
        .filter((o) => !(e ? Wa : Ma)(t, o))
        .map((e) => ({ details: e, pixelDelta: ja(t, e) })),
      ...
      (e, t, o, n) => {
        const r = t[0].row,
          ...
          l = z(
            s,
            (e, t) => ({
              grid: Jl(e.grid, r, t.row + e.delta, o, n.getOrInit),
              delta: e.delta + 1,
            }),
            { grid: e, delta: 0 }
          ).grid;
        return Oa(l, r, t[0].column);
      },
      zl,
      f,
      f,
    ...
    Va = _l(
      (e, t, o, n) => {
        const r = ka(t),
          s = r[r.length - 1],
          l = s.row + s.rowspan,
          a = z(r, (e, t) => Jl(e, l, t.row, o, n.getOrInit), e);
        return Oa(a, l, t[0].column);
      },
      zl,
      f,
      f,
    ...
    Ga = _l(
      (e, t, o, n) => {
        ...
        return Oa(s, r[0].row, Math.min(r[0].column, l));
      },
      (e, t) => Al(e, t).map((t) => ({ details: t, pixelDelta: -ja(e, t) })),
      La,
      Ra,
      pa
    ),
    Ka = _l(
      (e, t, o, n) => {
        ...
        return Oa(s, Math.min(t[0].row, l), t[0].column);
      },
      zl,
      f,
      Ra,
    ...
    Ya = _l(
      (e, t, o, n) => {
        const r = ma(t),
          s = E(r, (e) => e.column),
          l = na(e, s, !0, o, n.replaceOrInit);
        return Oa(l, t[0].row, t[0].column);
      },
      Al,
      f,
      f,
    ...
    ec = _l(
      (e, t, o, n) => {
        const r = ra(e, t, o, n.replaceOrInit);
        return Oa(r, t[0].row, t[0].column);
      },
      Al,
      f,
      f,
    ...
    oc = _l(
      (e, t, o, n) => {
        ...
        return Da(s, C.from(r[0]));
      },
      (e, t) => ((e, t) => t.mergable)(0, t).filter((t) => Ll(e, t.cells)),
      Aa,
      f,
      wa
    ),
    nc = _l(
      (e, t, o, n) => {
        const r = z(t, (e, t) => Wl(e, t, o, n.unmerge(t)), e);
        return Da(r, C.from(t[0]));
      },
      (e, t) => ((e, t) => t.unmergable)(0, t).filter((t) => Ll(e, t)),
      Aa,
      f,
      wa
    ),
    rc = _l(
      (e, t, o, n) => {
        ...
        return ((e, t, o, n, r) => {
            ...
            return ((e, t, o, n, r, s) => {
              ...
              for (let e = l; e < c; e++) {
                ...
                for (let c = a; c < i; c++) {
                  ...
                  Ul(t, e, c, r) && Wl(t, Ho(t[e], c), r, n.cell);
                  const i = c - a - s,
                    d = Fo(o[e - l], i),
                    u = d.element,
                    f = n.replace(u);
          ...
          () => Da(e, C.some(t.element)),
          (e) => Oa(e, t.row, t.column)
        );
      },
      (e, t) =>
        Vt(t.element).bind((o) =>
    ...
    sc = _l(
      (e, t, o, n) => {
        const r = Vo(e).rows,
          ...
          c = Kl(s, e, a, t.generators, o);
        return Oa(c, t.cells[0].row, t.cells[0].column);
      },
      Ia(!0),
      f,
      f,
    ...
    cc = _l(
      (e, t, o, n) => {
        const r = Vo(e).rows,
          ...
          a = za(t.clipboard, t.generators, l),
          c = Yl(s, e, a, t.generators, o);
        return Oa(c, s, t.cells[0].column);
      },
      Bl,
      f,
      f,
      ...
      return zl(o, t)
        .bind((e) => {
          const t = e[e.length - 1],
            ...
            s = M(
              E(o.all, (e) => B(e.cells, (e) => e.column >= n && e.column < r))
            );
          return ul(s);
        })
        .getOr("");
    ...
    vc = (e, t, o) => {
      const n = (e) => "table" === ne(os(e)),
        ...
        i = a(Ga, (t) => !n(e) || al(t).columns > 1, f, pc);
      return {
        deleteRow: c,
        deleteColumn: i,
        insertRowsBefore: a($a, x, f, pc),
        insertRowsAfter: a(Va, x, f, pc),
        insertColumnsBefore: a(qa, x, s, pc),
        insertColumnsAfter: a(Ua, x, s, pc),
        mergeCells: a(oc, x, f, pc),
        unmergeCells: a(nc, x, f, pc),
        pasteColsBefore: a(sc, x, f, pc),
        pasteColsAfter: a(lc, x, f, pc),
        pasteRowsBefore: a(ac, x, f, pc),
        pasteRowsAfter: a(cc, x, f, pc),
        pasteCells: a(rc, x, f, bc),
        makeCellsHeader: a(ec, x, f, pc),
        unmakeCellsHeader: a(tc, x, f, pc),
        makeColumnsHeader: a(Ya, x, f, pc),
        unmakeColumnsHeader: a(Ja, x, f, pc),
        makeRowsHeader: a(Qa, x, f, pc),
        makeRowsBody: a(Xa, x, f, pc),
        makeRowsFooter: a(Za, x, f, pc),
        getTableRowType: dc,
        getTableCellType: mc,
        getTableColType: ic,
      };
    ...
    Sc = (e, t, o) => {
      const n = o.substring(0, o.length - e.length),
        r = parseFloat(n);
      return n === r.toString() ? t(r) : Cc.invalid(o);
    },
    Tc = {
      ...Cc,
      from: (e) =>
    ...
    Dc = (e, t) =>
      0 === e.length ? t : z(e, (e, t) => Tc.from(t).fold(g(0), h, h) + e, 0),
    Oc = (e, t) =>
      Tc.from(e).fold(
        g(e),
        (e) => e + t + "px",
    ...
    kc = (e) => {
      ...
      return o
        .slice(0, o.length - 1)
        .concat([Oc(o[o.length - 1], Math.round(t.remainder))]);
    },
    Ec = Tc.from,
    Nc = (e, t, o) => {
      const n = Xo(e),
    ...
    Fc = (e, t, o, n, s) => {
      ...
      return (
        e.undoManager.ignore(() => {
          const r = ((e, t, o, n, r, s = jc) => {
            ...
            if (a && o > 0) {
              ...
              Ie(l, e);
              const s = Pc(o, t, "sectionCells" === r ? c : 0, n);
              $e(e, s);
            }
            const i = xe.fromTag("tbody");
            Ie(l, i);
            const m = Pc(a ? e - c : e, t, a ? 0 : o, n);
            return $e(i, m), l;
          })(o, t, s, n, Mr(e), a);
        ...
        bt(os(e), 'table[data-mce-id="__mce"]')
          .map(
            (t) => (
              $r(e)
                ? Wc(t)
                : Vr(e)
                ? Mc(t)
                : (Hr(e) || ((e) => r(e) && -1 !== e.indexOf("%"))(l.width)) &&
                  Lc(t),
              rs(t),
              we(t, "data-mce-id"),
              ((e, t) => {
  ...
  var Hc = trendymc.util.Tools.resolve("trendymc.FakeClipboard");
  const $c = "x-trendymc/dom-table-",
    Vc = $c + "rows",
    qc = $c + "columns",
    Uc = (e) => {
      const t = Hc.FakeClipboardItem(e);
      Hc.write([t]);
    },
    Gc = (e) => {
      var t;
      const o = null !== (t = Hc.read()) && void 0 !== t ? t : [];
      return V(o, (t) => C.from(t.getType(e)));
    },
    Kc = (e) => {
      Gc(e).isSome() && Hc.clear();
    },
    Yc = (e) => {
      e.fold(Qc, (e) => Uc({ [Vc]: e }));
    },
    ...
    oi = (e, t) => {
      const o = ns(e),
        n = (e) => Gt(e, o),
        l = (t) =>
          ((e) => Vs(ss(e), ns(e)).filter(ds))(e).bind((e) =>
            n(e).map((o) => t(o, e))
          ),
        a = (t) => {
          e.focus();
        ...
        i = () =>
          l((t, o) =>
              ...
              return zl(n, t)
                .bind((e) => {
                  const t = Ol(n, o, !1),
                    ...
                    s = j(r, (e) => {
                      const t = B(e.cells, (e) => !e.isLocked);
                  ...
                  E(e, (e) => {
                    ...
                    return (
                      N(e.cells, (e) => {
                        ...
                        Cl(o, "colspan", e.colspan, 1),
                          Cl(o, "rowspan", e.rowspan, 1),
                          Ie(t, o);
                      }),
                      t
                    );
            ...
            })(t, Fs(qs(e), t, o), _r(f, xe.fromDom(e.getDoc()), C.none()))
          ),
        m = () =>
          l((t, o) =>
            ((e, t) => {
              ...
              return Al(o, t).map((e) => {
                const t = e[e.length - 1],
                  ...
                  s = ((e, t, o) => {
                    if (sn(e)) {
                      const n = B(rn(e), xc(t, o)),
                        r = E(n, (e) => {
                          const n = Ye(e.element);
                          return yc(n, "span", o - t), n;
                        }),
                  ...
                  l = ((e, t, o) =>
                    E(e.all, (e) => {
                      const n = B(e.cells, xc(t, o)),
                        r = E(n, (e) => {
                          const n = Ye(e.element);
                          return yc(n, "colspan", o - t), n;
                        }),
                        s = xe.fromTag("tr");
                      return $e(s, r), s;
                    }))(o, n, r);
      ...
      G(
        {
          ...
          mceTableCutCol: () =>
            m().each((e) => {
              Xc(e), c(t.deleteColumn);
            }),
          mceTableCutRow: () =>
            i().each((e) => {
              Yc(e), c(t.deleteRow);
            }),
          mceTableCopyCol: () => m().each((e) => Xc(e)),
          mceTableCopyRow: () => i().each((e) => Yc(e)),
          mceTablePasteColBefore: () => d(t.pasteColsBefore, Zc),
          mceTablePasteColAfter: () => d(t.pasteColsAfter, Zc),
          mceTablePasteRowBefore: () => d(t.pasteRowsBefore, Jc),
          mceTablePasteRowAfter: () => d(t.pasteRowsAfter, Jc),
          mceTableDelete: () =>
            ti(e).each((t) => {
              Gt(t, o)
                .filter(w(o))
    ...
    gi = (e, t) => {
      const o = ((e, t) =>
        t.match({
          ...
          relative: (t, o) => ({
            ltr: Zt(() => ii(e, t, o)),
            rtl: Zt(() => C.some(ii(e, o, t))),
          }),
          exact: (t, o, n, r) => ({
            ltr: Zt(() => mi(e, t, o, n, r)),
            rtl: Zt(() => C.some(mi(e, n, r, t, o))),
          }),
        }))(e, t);
      return ((e, t) => {
        const o = t.ltr();
  ...
  ui.ltr, ui.rtl;
  const pi = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        ...
        : Os(o, n, t).bind((t) => {
            ...
            return n.length > 1
              ? (r(e, n, t.start, t.finish),
                C.some(si(C.some(vi(o, 0, o, wr(o))), !0)))
              : C.none();
          }),
    ...
    Ti = (e, t, o, n = Ti) => {
      ...
      return o.first(r).map((e) => xi(e, n));
    },
    Ri = [
      { current: Ci, next: Si, fallback: C.none() },
      { current: Si, next: Ti, fallback: C.some(Ci) },
      { current: Ti, next: Ti, fallback: C.some(Si) },
    ],
    Di = (e, t, o, n, r = Ri) =>
      L(r, (e) => e.current === o).bind((o) =>
        o
          .current(e, t, n, o.next)
          .orThunk(() => o.fallback.bind((o) => Di(e, t, o, n)))
      ),
    Oi = (e, t, o, n, r, s) =>
      Di(e, t, n, r).bind((t) =>
        s(t.item)
    ...
    Wi = {
      ...
      verify: (e, t, o, n, r, s, l) =>
        wt(n, "td,th", l)
          ...
          .getOr(Ai.none("default")),
      cata: (e, t, o, n, r) => e.fold(t, o, n, r),
    },
    Mi = ue("br"),
    ji = (e, t, o) =>
      t(e, o).bind((e) =>
        ie(e) && 0 === hr(e).trim().length ? ji(e, t, o) : C.some(e)
      ),
    Pi = (e, t, o, n) =>
      ((e, t) =>
        We(e, t)
          .filter(Mi)
          .orThunk(() => We(e, t - 1).filter(Mi)))(t, o).bind((t) =>
        n.traverse(t).fold(
          () => ji(t, n.gather, e).map(n.relative),
          (e) =>
            ((e) =>
              Ne(e).bind((t) => {
                const o = Le(t);
              ...
              }))(e).map((e) => ri.on(e.parent, e.index))
        )
      ),
    Ii = (e, t) => ({
      left: e.left,
    ...
    Ui = (e, t) =>
      ce(t)
        ? Vi(e, t).map($i)
        : ie(t)
        ? e.getRangedRect(t, 0, t, wr(t)).map($i)
        : C.none(),
    ...
    Ji = (e, t, o, n, r) =>
      0 === r
        ...
        ? ((e, t, o, n, r) => Ji(e, t, o, t.move(n, 5), r))(e, t, o, n, r - 1)
    ...
    tm = (e, t, o, n, r) =>
      qi(e, t, o).bind((t) => om(e, r, n(t, Xi.getJumpSize()))),
    om = (e, t, o) => {
      const n = No().browser;
      ...
      wt(n, "td,th", t).bind((n) =>
        wt(n, "table", t).bind((s) =>
          ((e, t) =>
            ...
            ? ((e, t, o) =>
                Zi(e, t, o).bind((n) =>
                  em(e, t, n.element, n.offset, o, 20).map(e.fromSitus)
                ))(e, t, o).bind((e) =>
    ...
    sm = (e, t, o, n, r, s) =>
      s(n, t).orThunk(() =>
        rm(e, t, o, n, r).map((e) => {
          const t = e.range;
          return si(C.some(vi(t.start, t.soffset, t.finish, t.foffset)), !0);
        })
      ),
    lm = (e, t) =>
      wt(e, "tr", t).bind((e) =>
        wt(e, "table", t).bind((o) => {
          const n = dt(o, "tr");
          return Re(e, n[0])
            ? ((e, t, o) => Ei(_i, e, (e) => Cr(e).isSome(), o))(o, 0, t).map(
                (e) => {
                  const t = wr(e);
                  return si(C.some(vi(e, t, e, t)), !0);
                }
              )
            : C.none();
        })
      ...
      wt(e, "tr", t).bind((e) =>
        wt(e, "table", t).bind((o) => {
          ...
          return Re(e, n[n.length - 1])
            ? ((e, t, o) => Ni(_i, e, (e) => xr(e).isSome(), o))(o, 0, t).map(
                (e) => si(C.some(vi(e, 0, e, 0)), !0)
              )
            : C.none();
        })
      ),
    cm = (e, t, o, n, r, s, l) =>
      rm(e, o, n, r, s).bind((e) => yi(t, o, e.start, e.finish, l)),
    im = (e) => {
      let t = e;
      return {
        get: () => t,
    ...
    Cm = {
      domRange: xm.domRange,
      relative: xm.relative,
      exact: xm.exact,
      exactFromRange: (e) => xm.exact(e.start, e.soffset, e.finish, e.foffset),
      getWin: (e) => {
        const t = ((e) =>
          e.match({
            domRange: (e) => xe.fromDom(e.startContainer),
            relative: (e, t) => ri.getStart(e),
            exact: (e, t, o, n) => e,
          }))(e);
    ...
    km = (e, t, o, n, r) => {
      const s = ((e, t, o, n) => {
        const r = Sm(e, t),
          s = Sm(o, n);
        return Cm.relative(r, s);
      })(t, o, n, r);
      Om(e, s);
    },
    Em = (e, t, o) => {
      const n = ((e, t) => {
        const o = e.fold(ri.before, Sm, ri.after),
          n = t.fold(ri.before, Sm, ri.after);
        return Cm.relative(o, n);
      })(t, o);
      Om(e, n);
    },
    Nm = (e) => {
    ...
    _m = (e) => {
      if (null === e.anchorNode || null === e.focusNode) return Nm(e);
      {
        ...
        return ((e, t, o, n) => {
          ...
          ? C.some(pi(t, e.anchorOffset, o, e.focusOffset))
          : Nm(e);
      }
    },
    Bm = (e, t, o = !0) => {
    ...
    zm = (e) =>
      ((e) =>
        Tm(e)
          ...
          .bind(_m))(e).map((e) =>
        Cm.exact(e.start, e.soffset, e.finish, e.foffset)
      ),
    Am = (e, t, o) =>
      ((e, t, o) =>
        ((e, t, o) =>
    ...
    Lm = (e) => ({
      ...
      getRangedRect: (t, o, n, r) => {
        const s = Cm.exact(t, o, n, r);
        return ((e, t) =>
          ((e) => {
            const t = e.getClientRects(),
              o = t.length > 0 ? t[0] : e.getBoundingClientRect();
            return o.width > 0 || o.height > 0 ? C.some(o).map(di) : C.none();
          })(hi(e, t)))(e, s);
      },
      getSelection: () => zm(e).map((t) => wi(e, t)),
      fromSitus: (t) => {
        const o = Cm.relative(t.start, t.finish);
        return wi(e, o);
      },
      situsFromPoint: (t, o) =>
        Am(e, t, o).map((e) => bi(e.start, e.soffset, e.finish, e.foffset)),
      clearSelection: () => {
        ((e) => {
          Tm(e).each((e) => e.removeAllRanges());
        })(e);
      },
      ...
      setSelection: (t) => {
        km(e, t.start, t.soffset, t.finish, t.foffset);
      },
    ...
    Fm = (e, t) => {
      Pm(e) ? e.dom.classList.add(t) : Im(e, t);
    },
    ...
    Ym = (e, t, o) =>
      ((e, t, o, n) =>
        ((e, t, o, n, r) => {
          ...
          return e.dom.addEventListener(t, s, r), { unbind: b(Gm, e, t, s, r) };
        })(e, t, o, n, !1))(e, t, Km, o),
    Jm = Um,
    Qm = (e) => !Hm(xe.fromDom(e.target), "ephox-snooker-resizer-bar"),
    Xm = (e, t) => {
      const o =
          ((r = Is.selectedSelector),
          {
            get: () =>
              _s(xe.fromDom(e.getBody()), r).fold(
                () => Vs(ss(e), ns(e)).fold($m, qm),
                Vm
              ),
          }),
        n = ((e, t, o) => {
      ...
      return (
        e.on("init", (o) => {
            ...
            a = ((e, t, o, n) => {
              const r = ((e, t, o, n) => {
                ...
                return {
                  clearstate: s,
                  mousedown: (e) => {
                    n.clear(t), dm(e.target, o).filter(um).each(r.set);
                  },
                  mouseover: (e) => {
                    l(e);
                  },
              ...
              return {
                keydown: (e, l, a, c, i, m) => {
                  const d = e.raw,
                    u = d.which,
                    f = !0 === d.shiftKey,
                    g = ks(t, n.selectedSelector).fold(
                      () => (
                        wm(u) && !f && n.clearBeforeUpdate(t),
                        wm(u) && f && !jm(l, c)
                          ? C.none
                          : bm(u) && f
                          ? b(cm, r, t, o, fm, c, l, n.selectRange)
                          : pm(u) && f
                          ? b(cm, r, t, o, gm, c, l, n.selectRange)
                          : bm(u)
                          ? b(sm, r, o, fm, c, l, am)
                          : pm(u)
                          ? b(sm, r, o, gm, c, l, lm)
                      ...
                      (e) => {
                        const o = (o) => () => {
                          ...
                          return s.fold(
                            ...
                            (e) => C.some(si(C.none(), !0))
                          );
                        };
                        return wm(u) && f && !jm(l, c)
                          ? C.none
                          : bm(u) && f
                          ? o([Wm(1, 0)])
                          : pm(u) && f
                ...
                keyup: (e, r, s, l, a) =>
                  ks(t, n.selectedSelector).fold(() => {
                    const c = e.raw,
                      i = c.which;
                    return !0 === c.shiftKey && wm(i) && jm(r, l)
                      ? ((e, t, o, n, r, s, l) =>
                          Re(o, r) && n === s
                            ? C.none()
                            : wt(o, "td,th", t).bind((o) =>
                                wt(r, "td,th", t).bind((n) => yi(e, t, o, n, l))
          ...
          e.on("dragstart", (e) => {
            ...
            e.on("mouseup", (e) => {
              d(e) && Qm(e) && a.mouseup(Jm(e));
            }),
            e.on("touchend", u.touchEnd),
            e.on("keyup", (t) => {
              const o = Jm(t);
              if (o.raw.shiftKey && wm(o.raw.which)) {
            ...
            e.on("NodeChange", () => {
              ...
              Rs(Gt, [o, r]).fold(() => n.clear(s), f);
            });
        }),
        e.on("PreInit", () => {
          e.serializer.addTempAttr(Is.firstSelected),
            e.serializer.addTempAttr(Is.lastSelected);
        }),
        {
          getSelectedCells: () =>
            ((e, t) => {
    ...
    od = (e, t) => {
      ...
      o.length > 0 &&
        ((e) => {
          throw new Error("Unsupported keys for object: " + td(e).join(", "));
        })(o);
    },
    nd = (e) =>
      ((e, t) =>
          ...
          return (
            ...
            (n) => {
              ...
              P(t, (e) => D(r, e)) ||
                ...
                e(t, r);
              const s = B(t, (e) => !o.validate(n[e], e));
              return (
                s.length > 0 &&
                  ((e, t) => {
                    throw new Error(
  ...
  var md = rd({
    ...
    sink: (e, t) => {
      const o = ((e) => {
        ...
        l = Ym(o.element(), "mouseout", e.delayDrop);
      return sd({
        element: o.element,
        start: (e) => {
          Ie(e, o.element());
  ...
  const dd = cd("ephox-snooker").resolve,
    ud = dd("resizer-bar"),
    fd = dd("resizer-rows"),
    gd = dd("resizer-cols"),
    hd = (e) => {
      const t = dt(e.parent(), "." + ud);
      N(t, qe);
    },
    pd = (e, t, o) => {
      const n = e.origin();
        ...
        pd(e, t, (e, t) => {
          const r = ((e, t, o, n) => {
            ...
            return (
              ...
              he(r, { "data-row": e, role: "presentation" }),
              r
            );
    ...
    Sd = (e) => {
      const t = (() => {
          const e = ed({ drag: Zm(["xDelta", "yDelta", "target"]) });
          let t = C.none();
          const o = (() => {
            const e = ed({ drag: Zm(["xDelta", "yDelta"]) });
            return {
              mutate: (t, o) => {
                e.trigger.drag(t, o);
              },
        ...
        o = ((e, t = {}) => {
          ...
          })(e, null !== (o = t.mode) && void 0 !== o ? o : md, t);
        })(t, {});
      let n = C.none();
      ...
      const l = (n, r) => {
        ...
        c = Ym(e.parent(), "mousedown", (e) => {
          var t;
          (t = e.target),
            Hm(t, fd) && l(e.target, "top"),
            ((e) => Hm(e, gd))(e.target) && l(e.target, "left");
        }),
        i = (t) => Re(t, e.view()),
        m = Ym(e.view(), "mouseover", (t) => {
          var r;
          ((r = t.target), wt(r, "table", i).filter(es)).fold(
            () => {
              st(t.target) && hd(e);
            },
            (t) => {
              o.isActive() && ((n = C.some(t)), wd(e, t));
            }
          );
        }),
        d = ed({
          adjustHeight: Zm(["table", "delta", "row"]),
          adjustWidth: Zm(["table", "delta", "column"]),
          startAdjust: Zm([]),
        });
      return {
        destroy: () => {
          c.unbind(), m.unbind(), o.destroy(), hd(e);
        },
        refresh: (t) => {
          wd(e, t);
        },
  ...
  const Rd = (e, t) => {
      const o = ((e) =>
          !((e) =>
            ...
            ((e) => {
              var t;
              if (!e.inline) return C.none();
              const o = null !== (t = Jr(e)) && void 0 !== t ? t : "";
              if (o.length > 0) return bt(lt(), o);
              const n = Qr(e);
              return m(n) ? C.some(xe.fromDom(n)) : C.none();
            })(e).isSome())(e) && "split" === Xr(e))(e),
    ...
    Ed = (e) => {
      ...
      const c = (t) => wc(e, t),
        ...
        m = (t, o, n, m) => {
          const d = ((e) => {
              return Tt((t = e), "corner-") ? ((e) => e.substring(7))(t) : t;
              var t;
            })(o),
            u = Rt(d, "e"),
            f = Tt(d, "n");
        ...
        if (
          ...
          const n = ((e, t, o) => {
            const n = _n,
              ...
              s = Sd(e),
              l = ed({
                beforeResize: Zm(["table", "type"]),
                afterResize: Zm(["table", "type"]),
                startDrag: Zm([]),
              });
            return (
              s.events.adjustHeight.bind((e) => {
                ...
                ia(t, o, e.row), l.trigger.afterResize(t, "row");
              }),
              ...
              s.events.adjustWidth.bind((e) => {
                ...
                const s = r.delta(e.delta, n),
                  a = o(n);
                ca(n, s, e.column, t, a), l.trigger.afterResize(n, "col");
              }),
              {
                on: s.on,
                off: s.off,
